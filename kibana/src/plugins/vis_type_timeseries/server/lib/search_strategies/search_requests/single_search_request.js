...
exports.SingleSearchRequest = void 0;
...
class SingleSearchRequest extends _abstract_request.AbstractSearchRequest {
  async search([{
    body,
    index
  }]) {
...
exports.SingleSearchRequest = SingleSearchRequest;