...
var _stub_browser_storage = require("test_utils/stub_browser_storage");

var _hashed_item_store = require("./hashed_item_store");
 ...
 */
var mockStorage = new _stub_browser_storage.StubBrowserStorage();
exports.mockStorage = mockStorage;
var mockHashedItemStore = new _hashed_item_store.HashedItemStore(mockStorage);
jest.mock('./', function () {
  return {
