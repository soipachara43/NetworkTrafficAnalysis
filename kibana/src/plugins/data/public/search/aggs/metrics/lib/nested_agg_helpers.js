 ...
 */
var forwardModifyAggConfigOnSearchRequestStart = function forwardModifyAggConfigOnSearchRequestStart(paramName) {
  return function (aggConfig, searchSource, request) {
    if (!aggConfig || !aggConfig.params) {
      return;
    }

    var nestedAggConfig = aggConfig.getParam(paramName);
