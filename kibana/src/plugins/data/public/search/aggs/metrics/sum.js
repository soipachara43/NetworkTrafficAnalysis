 ...
 * under the License.
 */
var sumTitle = _i18n.i18n.translate('data.search.aggs.metrics.sumTitle', {
  defaultMessage: 'Sum'
});

var sumMetricAgg = new _metric_agg_type.MetricAggType({
...
exports.sumMetricAgg = sumMetricAgg;