...
function tabifyGetColumns(aggs, minimalColumns) {
  ...
  var columns = []; // separate the metrics

  var grouped = (0, _lodash.groupBy)(aggs, function (agg) {
  ...
  var columnIndex = 0; // return the buckets, and after each place all of the metrics
