...
/*#__PURE__*/
function (_KbnError) {
  _inherits(IndexPatternMissingIndices, _KbnError);
  ...
  function IndexPatternMissingIndices(message) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(IndexPatternMissingIndices).call(this, message && message.length ? "No matching indices found: ".concat(message) : defaultMessage));
  }
