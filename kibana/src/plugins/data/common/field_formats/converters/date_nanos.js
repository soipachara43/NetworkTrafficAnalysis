...
class DateNanosFormat extends _field_format.FieldFormat {
  constructor(...args) {
    super(...args);
...
_defineProperty(DateNanosFormat, "id", _types2.FIELD_FORMAT_IDS.DATE_NANOS);

_defineProperty(DateNanosFormat, "title", _i18n.i18n.translate('data.fieldFormats.date_nanos.title', {
  defaultMessage: 'Date nanos'
}));

_defineProperty(DateNanosFormat, "fieldType", _types.KBN_FIELD_TYPES.DATE);