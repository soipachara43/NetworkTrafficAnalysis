...
function toElasticsearchQuery(node, indexPattern, config = {}, context = {}) {
  ...
  const fullPath = (context === null || context === void 0 ? void 0 : (_context$nested = context.nested) === null || _context$nested === void 0 ? void 0 : _context$nested.path) ? `${context.nested.path}.${stringPath}` : stringPath;
  return {
    nested: {
      path: fullPath,
