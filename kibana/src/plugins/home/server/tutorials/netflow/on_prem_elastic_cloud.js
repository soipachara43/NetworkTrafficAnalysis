...
var _logstash_instructions = require("../instructions/logstash_instructions");

var _onprem_cloud_instructions = require("../instructions/onprem_cloud_instructions");
...
function createOnPremElasticCloudInstructions() {
  ...
  return {
    instructionSets: [{
      title: _i18n.i18n.translate('home.tutorials.netflow.onPremElasticCloudInstructions.title', {
