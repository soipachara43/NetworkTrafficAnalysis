...
exports.createFunctionbeatCloudInstructions = exports.createFunctionbeatInstructions = void 0;
  ...
  INSTALL: {
    OSX: {
      ...
      textPre: _i18n.i18n.translate('home.tutorials.common.functionbeatInstructions.install.osxTextPre', {
        ...
        values: {
          link: '{config.docs.beats.functionbeat}/functionbeat-getting-started.html'
        }
      }),
...
Kibana index pattern. It is normally safe to omit this command.'
  ...
  CONFIG: {
    OSX_LINUX: {
      ...
      textPost: _i18n.i18n.translate('home.tutorials.common.functionbeatInstructions.config.osxTextPost', {
...
and {kibanaUrlTemplate} is the URL of Kibana.',
    ...
    WINDOWS: {
      ...
      commands: ['output.elasticsearch:', '  hosts: ["<es_url>"]', '  username: "elastic"', '  password: "<password>"', 'setup.kibana:', '  host: "<kibana_url>"', (0, _get_space_id_for_beats_tutorial.getSpaceIdForBeatsTutorial)(context)],
      textPost: _i18n.i18n.translate('home.tutorials.common.functionbeatInstructions.config.windowsTextPost', {
        defaultMessage: 'Where {passwordTemplate} is the password of the `elastic` user, {esUrlTemplate} is the URL of Elasticsearch, \
and {kibanaUrlTemplate} is the URL of Kibana.',
        values: {
          passwordTemplate: '`<password>`',
