...
exports.createMetricbeatCloudInstructions = exports.createMetricbeatInstructions = void 0;
  ...
  INSTALL: {
    OSX: {
      ...
      textPre: _i18n.i18n.translate('home.tutorials.common.metricbeatInstructions.install.osxTextPre', {
        ...
        values: {
          link: '{config.docs.beats.metricbeat}/metricbeat-getting-started.html'
        }
      }),
