...
function formatAngularHttpError(error) {
  ...
  if (error.status === -1) {
    ...
    return _i18n.i18n.translate('kibana_legacy.notify.fatalError.unavailableServerErrorMessage', {
  ...
  return _i18n.i18n.translate('kibana_legacy.notify.fatalError.errorStatusMessage', {
