...
exports.instance = exports.EditorRegistry = void 0;
...
function () {
  function EditorRegistry() {
    ...
    _defineProperty(this, "inputEditor", void 0);
  }

  _createClass(EditorRegistry, [{
    key: "setInputEditor",
    value: function setInputEditor(inputEditor) {
...
var instance = new EditorRegistry();
