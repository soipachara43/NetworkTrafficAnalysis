...
var createReactOverlays = function createReactOverlays(services) {
  ...
  var openFlyout = function openFlyout(node, options) {
    checkCoreService();
    return services.overlays.openFlyout((0, _util.toMountPoint)(React.createElement(React.Fragment, null, node)), options);
  };

  var openModal = function openModal(node, options) {
    checkCoreService();
    return services.overlays.openModal((0, _util.toMountPoint)(React.createElement(React.Fragment, null, node)), options);
  };
