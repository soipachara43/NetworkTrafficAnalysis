...
function createBundlesRoute({
  ...
  const fileHashCache = new _lruCache.default(100);
  ...
  return [buildRouteForBundles(`${basePublicPath}/bundles/kbn-ui-shared-deps/`, '/bundles/kbn-ui-shared-deps/', UiSharedDeps.distDir, fileHashCache), ...npUiPluginPublicDirs.map(({
    id,
    path
  }) => buildRouteForBundles(`${basePublicPath}/bundles/plugin/${id}/`, `/bundles/plugin/${id}/`, path, fileHashCache)), buildRouteForBundles(`${basePublicPath}/bundles/`, '/bundles/', regularBundlesPath, fileHashCache), buildRouteForBundles(`${basePublicPath}/built_assets/dlls/`, '/built_assets/dlls/', dllBundlesPath, fileHashCache), buildRouteForBundles(`${basePublicPath}/`, '/built_assets/css/', builtCssPath, fileHashCache)];
}
