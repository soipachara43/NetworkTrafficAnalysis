...
function isNpUiPluginPublicDirs(something) {
  return Array.isArray(something) && something.every(s => typeof s === 'object' && s && typeof s.id === 'string' && typeof s.path === 'string');
}

function assertIsNpUiPluginPublicDirs(something) {
