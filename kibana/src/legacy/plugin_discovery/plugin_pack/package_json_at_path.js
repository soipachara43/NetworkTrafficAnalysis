...
exports.createPackageJsonAtPath$ = void 0;
...
const createPackageJsonAtPath$ = path => // If plugin directory contains manifest file, we should skip it since it
// should have been handled by the core plugin system already.
Rx.defer(() => (0, _plugins.isNewPlatformPlugin)(path)).pipe((0, _operators.mergeMap)(isNewPlatformPlugin => isNewPlatformPlugin ? [] : createPackageJsonAtPath(path)), (0, _operators.map)(packageJson => ({
  packageJson
})), (0, _operators.catchError)(error => [{
  error
}]));

exports.createPackageJsonAtPath$ = createPackageJsonAtPath$;