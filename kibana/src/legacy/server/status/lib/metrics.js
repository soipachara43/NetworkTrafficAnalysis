...
var _case_conversion = require("./case_conversion");
...
class Metrics {
  ...
  async captureEvent(hapiEvent) {
    ...
    return {
      ...
      response_times: {
        avg_in_millis: isNaN(avgInMillis) ? undefined : avgInMillis,
        // convert NaN to undefined
        max_in_millis: maxInMillis
      },
      requests: { ...requestDefaults,
        ...(0, _case_conversion.keysToSnakeCaseShallow)((0, _lodash.get)(hapiEvent, ['requests', port]))
      },
