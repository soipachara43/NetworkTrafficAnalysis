...
exports.get = get;
exports.defaults = exports.getAllById = exports.getAll = void 0;
...
const getAllById = () => _lodash.default.indexBy(exports.getAll(), 'id');
...
function get(id) {
  return exports.getAllById()[id] || _lodash.default.defaults({
    id: id
  }, exports.defaults);
}