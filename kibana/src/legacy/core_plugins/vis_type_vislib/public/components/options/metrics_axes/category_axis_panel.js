...
function CategoryAxisPanel(_ref) {
  ...
  var setAxisLabel = (0, _react.useCallback)(function (paramName, value) {
    var labels = _objectSpread({}, axis.labels, _defineProperty({}, paramName, value));
  ...
  return _react.default.createElement(_eui.EuiPanel, {
    ...
    label: _i18n.i18n.translate('visTypeVislib.controls.pointSeries.categoryAxis.positionLabel', {
    ...
    label: _i18n.i18n.translate('visTypeVislib.controls.pointSeries.categoryAxis.showLabel', {
      defaultMessage: 'Show axis lines and labels'
    }),
    paramName: "show",
    value: axis.show,
    setValue: setAxis
  }), axis.show && _react.default.createElement(_label_options.LabelOptions, {
