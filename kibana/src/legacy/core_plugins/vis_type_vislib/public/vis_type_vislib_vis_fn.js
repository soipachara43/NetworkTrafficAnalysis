...
exports.createVisTypeVislibVisFn = void 0;
 ...
 */
// @ts-ignore
var createVisTypeVislibVisFn = function createVisTypeVislibVisFn() {
  return {
    name: 'vislib',
    type: 'render',
    ...
    fn: function fn(context, args) {
      var visConfigParams = JSON.parse(args.visConfig);
      var convertedData = (0, _response_handler.vislibSeriesResponseHandler)(context, visConfigParams.dimensions);
      return {
        type: 'render',
        as: 'visualization',
        value: {
