...
/* options */
{
  server.injectUiAppVars('canvas', () => {
    ...
    return {
      ...
      serverFunctions: server.newPlatform.setup.plugins.expressions.__LEGACY.registries().serverFunctions.toArray(),
      basePath,
  ...
  server.expose(server.newPlatform.setup.plugins.expressions.__LEGACY);
}