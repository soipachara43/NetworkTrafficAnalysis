...
var createTableVisFn = function createTableVisFn() {
  return {
    ...
    fn: function fn(input, args) {
      var visConfig = args.visConfig && JSON.parse(args.visConfig);
      var convertedData = (0, _table_vis_response_handler.tableVisResponseHandler)(input, visConfig.dimensions);
      return {
        type: 'render',
        as: 'visualization',
        value: {
