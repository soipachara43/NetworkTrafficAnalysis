...
var DisabledLabEmbeddable =
/*#__PURE__*/
function (_Embeddable) {
  _inherits(DisabledLabEmbeddable, _Embeddable);

  function DisabledLabEmbeddable(title, initialInput) {
    var _this;

    _classCallCheck(this, DisabledLabEmbeddable);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(DisabledLabEmbeddable).call(this, initialInput, {
      title: title
    }));
    _this.title = title;
  ...
  _createClass(DisabledLabEmbeddable, [{
    key: "reload",
    ...
    value: function render(domNode) {
      if (this.title) {
        ...
        _reactDom.default.render(_react.default.createElement(_disabled_lab_visualization.DisabledLabVisualization, {
          title: this.title
        }), domNode);
      }
    }
