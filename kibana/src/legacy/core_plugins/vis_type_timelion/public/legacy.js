...
var setupPlugins = {
  ...
  data: _legacy_imports.npSetup.plugins.data,
  visualizations: _legacy.setup
};
var pluginInstance = (0, _.plugin)({});
var setup = pluginInstance.setup(_legacy_imports.npSetup.core, setupPlugins);
exports.setup = setup;
var start = pluginInstance.start(_legacy_imports.npStart.core, _legacy_imports.npStart.plugins);
exports.start = start;