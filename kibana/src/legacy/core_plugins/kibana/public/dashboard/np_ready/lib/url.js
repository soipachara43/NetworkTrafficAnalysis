...
exports.getDashboardIdFromUrl = getDashboardIdFromUrl;
...
function getDashboardIdFromUrl(url) {
  ...
  var _ref = (_url$match = url.match(/dashboard\/(.*?)(\/|\?|$)/)) !== null && _url$match !== void 0 ? _url$match : [undefined, // full match
  undefined],
      _ref2 = _slicedToArray(_ref, 2),
      dashboardId = _ref2[1];

  return dashboardId !== null && dashboardId !== void 0 ? dashboardId : undefined;
}