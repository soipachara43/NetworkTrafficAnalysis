...
function createInitialQueryParametersState() {
  var defaultStepSize = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 5;
  var tieBreakerField = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '_doc';
  return {
    anchorType: null,
    anchorId: null,
    columns: [],
