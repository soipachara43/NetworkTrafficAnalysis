...
function getUiSettingDefaults() {
  ...
  const [defaultWeekday] = weekdays; // We add the `en` key manually here, since that's not a real numeral locale, but the
  // default fallback in case the locale is not found.

  const numeralLanguageIds = ['en', ..._languages.default.map(function (numeralLanguage) {
  ...
  return {
    ...
    defaultRoute: {
      name: _i18n.i18n.translate('kbn.advancedSettings.defaultRoute.defaultRouteTitle', {
        defaultMessage: 'Default route'
      }),
      value: '/app/kibana',
      schema: _configSchema.schema.string({
        validate(value) {
          if (!value.startsWith('/') || !(0, _utils.isRelativeUrl)(value)) {
            return _i18n.i18n.translate('kbn.advancedSettings.defaultRoute.defaultRouteIsRelativeValidationMessage', {
      ...
      description: _i18n.i18n.translate('kbn.advancedSettings.defaultRoute.defaultRouteText', {
    ...
    dateFormat: {
      ...
      description: _i18n.i18n.translate('kbn.advancedSettings.dateFormatText', {
        ...
        values: {
          formatLink: '<a href="https://momentjs.com/docs/#/displaying/format/" target="_blank" rel="noopener noreferrer">' + _i18n.i18n.translate('kbn.advancedSettings.dateFormat.optionsLinkText', {
    ...
    'dateFormat:tz': {
      ...
      type: 'select',
      options: ['Browser', ..._momentTimezone.default.tz.names()],
  ...
  ["P1YT", "YYYY"]
    ...
    dateNanosFormat: {
      name: _i18n.i18n.translate('kbn.advancedSettings.dateNanosFormatTitle', {
        defaultMessage: 'Date with nanoseconds format'
      }),
      value: 'MMM D, YYYY @ HH:mm:ss.SSSSSSSSS',
      description: _i18n.i18n.translate('kbn.advancedSettings.dateNanosFormatText', {
        defaultMessage: 'Used for the {dateNanosLink} datatype of Elasticsearch',
        values: {
          dateNanosLink: '<a href="https://www.elastic.co/guide/en/elasticsearch/reference/master/date_nanos.html" target="_blank" rel="noopener noreferrer">' + _i18n.i18n.translate('kbn.advancedSettings.dateNanosLinkTitle', {
    ...
    'discover:searchOnPageLoad': {
      name: _i18n.i18n.translate('kbn.advancedSettings.discover.searchOnPageLoadTitle', {
        defaultMessage: 'Search on page load'
      }),
      value: true,
      type: 'boolean',
      description: _i18n.i18n.translate('kbn.advancedSettings.discover.searchOnPageLoadText', {
    ...
    'courier:batchSearches': {
      name: _i18n.i18n.translate('kbn.advancedSettings.courier.batchSearchesTitle', {
        defaultMessage: 'Batch concurrent searches'
      }),
      value: false,
      type: 'boolean',
      description: _i18n.i18n.translate('kbn.advancedSettings.courier.batchSearchesText', {
      ...
      deprecation: {
        message: _i18n.i18n.translate('kbn.advancedSettings.courier.batchSearchesTextDeprecation', {
    ...
    'visualization:heatmap:maxBuckets': {
      name: _i18n.i18n.translate('kbn.advancedSettings.visualization.heatmap.maxBucketsTitle', {
        defaultMessage: 'Heatmap maximum buckets'
      }),
      value: 50,
      type: 'number',
      description: _i18n.i18n.translate('kbn.advancedSettings.visualization.heatmap.maxBucketsText', {
  ...
  "value": 0
    ...
    'timepicker:quickRanges': {
      ...
      value: JSON.stringify([{
        from: 'now/d',
        to: 'now/d',
        display: _i18n.i18n.translate('kbn.advancedSettings.timepicker.today', {
          defaultMessage: 'Today'
        })
      }, {
        from: 'now/w',
        to: 'now/w',
        display: _i18n.i18n.translate('kbn.advancedSettings.timepicker.thisWeek', {
          defaultMessage: 'This week'
        })
      }, {
        from: 'now-15m',
        to: 'now',
        display: _i18n.i18n.translate('kbn.advancedSettings.timepicker.last15Minutes', {
          defaultMessage: 'Last 15 minutes'
        })
      }, {
        from: 'now-30m',
        to: 'now',
        display: _i18n.i18n.translate('kbn.advancedSettings.timepicker.last30Minutes', {
          defaultMessage: 'Last 30 minutes'
        })
      }, {
        from: 'now-1h',
        to: 'now',
        display: _i18n.i18n.translate('kbn.advancedSettings.timepicker.last1Hour', {
          defaultMessage: 'Last 1 hour'
        })
      }, {
        from: 'now-24h',
        to: 'now',
        display: _i18n.i18n.translate('kbn.advancedSettings.timepicker.last24Hours', {
          defaultMessage: 'Last 24 hours'
        })
      }, {
        from: 'now-7d',
        to: 'now',
        display: _i18n.i18n.translate('kbn.advancedSettings.timepicker.last7Days', {
          defaultMessage: 'Last 7 days'
        })
      }, {
        from: 'now-30d',
        to: 'now',
        display: _i18n.i18n.translate('kbn.advancedSettings.timepicker.last30Days', {
          defaultMessage: 'Last 30 days'
        })
      }, {
        from: 'now-90d',
        to: 'now',
        display: _i18n.i18n.translate('kbn.advancedSettings.timepicker.last90Days', {
          defaultMessage: 'Last 90 days'
        })
      }, {
        from: 'now-1y',
        to: 'now',
        display: _i18n.i18n.translate('kbn.advancedSettings.timepicker.last1Year', {
