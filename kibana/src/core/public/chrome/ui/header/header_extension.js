...
function (_React$Component) {
  _inherits(HeaderExtension, _React$Component);
  ...
  function HeaderExtension() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(HeaderExtension)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "ref", _react.default.createRef());

    _defineProperty(_assertThisInitialized(_this), "unrender", void 0);

    return _this;
  }

  _createClass(HeaderExtension, [{
    ...
    key: "unrenderExtension",
    value: function unrenderExtension() {
      if (this.unrender) {
        this.unrender();
