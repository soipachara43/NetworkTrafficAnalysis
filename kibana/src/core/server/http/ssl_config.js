...
class SslConfig {
  ...
  constructor(config) {
    ...
    if ((_config$keystore = config.keystore) === null || _config$keystore === void 0 ? void 0 : _config$keystore.path) {
      const {
        key,
        cert,
        ca
    ...
    if ((_config$truststore = config.truststore) === null || _config$truststore === void 0 ? void 0 : _config$truststore.path) {
