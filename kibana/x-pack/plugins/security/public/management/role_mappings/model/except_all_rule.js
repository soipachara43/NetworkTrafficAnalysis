...
/*#__PURE__*/
function (_RuleGroup) {
  _inherits(ExceptAllRule, _RuleGroup);

  function ExceptAllRule() {
    var _this;

    var rules = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

    _classCallCheck(this, ExceptAllRule);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ExceptAllRule).call(this));
    _this.rules = rules;
    return _this;
  }
  ...
  _createClass(ExceptAllRule, [{
    ...
    value: function getDisplayTitle() {
      return _i18n.i18n.translate('xpack.security.management.editRoleMapping.exceptAllRule.displayTitle', {
    ...
    value: function clone() {
      return new ExceptAllRule(this.rules.map(function (r) {
        return r.clone();
      }));
    }
    /** {@see RuleGroup.toRaw} */
  ...
  return ExceptAllRule;
}(_rule_group.RuleGroup);

exports.ExceptAllRule = ExceptAllRule;