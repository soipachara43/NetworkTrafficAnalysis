...
/*#__PURE__*/
function (_RuleGroup) {
  _inherits(ExceptAnyRule, _RuleGroup);

  function ExceptAnyRule() {
    var _this;

    var rules = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

    _classCallCheck(this, ExceptAnyRule);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ExceptAnyRule).call(this));
    _this.rules = rules;
    return _this;
  }
  ...
  _createClass(ExceptAnyRule, [{
    ...
    value: function canContainRules(rules) {
      var forbiddenRules = [_except_all_rule.ExceptAllRule, ExceptAnyRule];
    ...
    value: function clone() {
      return new ExceptAnyRule(this.rules.map(function (r) {
        return r.clone();
      }));
    }
    /** {@see RuleGroup.toRaw} */
