...
exports.defineSessionRoutes = defineSessionRoutes;
...
function defineSessionRoutes({
  ...
  router.get({
    ...
    try {
      const sessionInfo = await authc.getSessionInfo(request); // This is an authenticated request, so sessionInfo will always be non-null.
