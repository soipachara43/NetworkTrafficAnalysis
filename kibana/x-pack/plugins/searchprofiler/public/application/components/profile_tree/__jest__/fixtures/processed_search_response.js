...
exports.processedResponseWithFirstShard = void 0;
...
search1.children[0] = search1Child;
searchRoot.treeRoot = search1;
shard1.searches[0] = searchRoot;
var processedResponseWithFirstShard = (0, _immer.produce)(null, function () {
  return [{
    shards: [shard1],
    time: 0.058419,
    name: '.kibana_1',
...
exports.processedResponseWithFirstShard = processedResponseWithFirstShard;