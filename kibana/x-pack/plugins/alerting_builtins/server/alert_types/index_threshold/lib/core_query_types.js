...
const CoreQueryParamsSchema = _configSchema.schema.object(CoreQueryParamsSchemaProperties);
...
function validateCoreQueryBody(anyParams) {
  ...
  if (aggType !== 'count' && !aggField) {
    return _i18n.i18n.translate('xpack.alertingBuiltins.indexThreshold.aggTypeRequiredErrorMessage', {
  ...
  if (groupBy === 'top') {
    if (termField == null) {
      return _i18n.i18n.translate('xpack.alertingBuiltins.indexThreshold.termFieldRequiredErrorMessage', {
        defaultMessage: '[termField]: termField required when [groupBy] is top'
      });
    }

    if (termSize == null) {
      return _i18n.i18n.translate('xpack.alertingBuiltins.indexThreshold.termSizeRequiredErrorMessage', {
        defaultMessage: '[termSize]: termSize required when [groupBy] is top'
      });
    }

    if (termSize > _index.MAX_GROUPS) {
      return _i18n.i18n.translate('xpack.alertingBuiltins.indexThreshold.invalidTermSizeMaximumErrorMessage', {
...
function validateAggType(aggType) {
  ...
  return _i18n.i18n.translate('xpack.alertingBuiltins.indexThreshold.invalidAggTypeErrorMessage', {
...
function validateGroupBy(groupBy) {
  ...
  return _i18n.i18n.translate('xpack.alertingBuiltins.indexThreshold.invalidGroupByErrorMessage', {
...
function validateTimeWindowUnits(timeWindowUnit) {
  ...
  return _i18n.i18n.translate('xpack.alertingBuiltins.indexThreshold.invalidTimeWindowUnitsErrorMessage', {
