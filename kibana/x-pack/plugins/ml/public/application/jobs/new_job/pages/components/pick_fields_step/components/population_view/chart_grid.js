...
var ChartGrid = function ChartGrid(_ref) {
  var aggFieldPairList = _ref.aggFieldPairList,
      ...
      fieldValuesPerDetector = _ref.fieldValuesPerDetector,
  ...
  return _react.default.createElement(_eui.EuiFlexGrid, {
    ...
    }, _react.default.createElement(_react.Fragment, null, _react.default.createElement(_eui.EuiFlexGroup, null, _react.default.createElement(_eui.EuiFlexItem, null, _react.default.createElement(_detector_title.DetectorTitle, {
      index: i,
      agg: aggFieldPairList[i].agg,
      field: aggFieldPairList[i].field,
      byField: aggFieldPairList[i].by,
      deleteDetector: deleteDetector
    }, deleteDetector !== undefined && _react.default.createElement(_split_field.ByFieldSelector, {
      detectorIndex: i
    })), jobType === _new_job.JOB_TYPE.POPULATION && _react.default.createElement(_eui.EuiSpacer, {
      size: "s"
    }))), _react.default.createElement(_split_cards.SplitCards, {
