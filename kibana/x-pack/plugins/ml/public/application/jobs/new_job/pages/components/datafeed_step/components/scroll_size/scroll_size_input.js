...
var ScrollSizeInput = function ScrollSizeInput() {
  ...
  var _useState = (0, _react.useState)(jobValidator.scrollSize),
      _useState2 = _slicedToArray(_useState, 2),
      validation = _useState2[0],
      setValidation = _useState2[1];

  var _useState3 = (0, _react.useState)(jobCreator.scrollSize === null ? '' : "".concat(jobCreator.scrollSize)),
      _useState4 = _slicedToArray(_useState3, 2),
      scrollSizeString = _useState4[0],
      setScrollSize = _useState4[1];

  var _getNewJobDefaults = (0, _ml_server_info.getNewJobDefaults)(),
      datafeeds = _getNewJobDefaults.datafeeds;

  var scrollSizeDefault = datafeeds.scroll_size !== undefined ? "".concat(datafeeds.scroll_size) : '';
  (0, _react.useEffect)(function () {
    jobCreator.scrollSize = scrollSizeString === '' ? null : +scrollSizeString;
    jobCreatorUpdate();
  }, [scrollSizeString]);
  (0, _react.useEffect)(function () {
    setScrollSize(jobCreator.scrollSize === null ? '' : "".concat(jobCreator.scrollSize));
  }, [jobCreatorUpdate]);
  (0, _react.useEffect)(function () {
  ...
  return _react.default.createElement(_description.Description, {
    ...
    onChange: function onChange(e) {
      return setScrollSize(e.target.value);
    },
