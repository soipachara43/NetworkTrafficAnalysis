...
var JobDescriptionInput = function JobDescriptionInput() {
  ...
  var _useState = (0, _react.useState)(jobCreator.description),
      _useState2 = _slicedToArray(_useState, 2),
      jobDescription = _useState2[0],
      setJobDescription = _useState2[1];

  (0, _react.useEffect)(function () {
    jobCreator.description = jobDescription;
    jobCreatorUpdate();
  }, [jobDescription]);
  return _react.default.createElement(_description.Description, null, _react.default.createElement(_eui.EuiTextArea, {
