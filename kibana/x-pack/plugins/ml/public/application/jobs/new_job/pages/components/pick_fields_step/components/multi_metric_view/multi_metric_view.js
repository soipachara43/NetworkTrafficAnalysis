...
exports.MultiMetricView = void 0;
...
var MultiMetricView = function MultiMetricView(_ref) {
  ...
  return _react.default.createElement(_react.Fragment, null, isActive === false ? _react.default.createElement(_metric_selection_summary.MultiMetricDetectorsSummary, null) : _react.default.createElement(_react.Fragment, null, _react.default.createElement(_metric_selection.MultiMetricDetectors, {
    ...
    margin: "l"
  }), _react.default.createElement(_settings.MultiMetricSettings, {
    setIsValid: setSettingsValid
  }))));
};

exports.MultiMetricView = MultiMetricView;