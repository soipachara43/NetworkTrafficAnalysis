...
var AdvancedView = function AdvancedView(_ref) {
  ...
  return _react.default.createElement(_react.Fragment, null, isActive === false ? _react.default.createElement(_metric_selection_summary.AdvancedDetectorsSummary, null) : _react.default.createElement(_react.Fragment, null, _react.default.createElement(_extra.ExtraSettings, null), _react.default.createElement(_eui.EuiHorizontalRule, {
    margin: "l"
  }), _react.default.createElement(_metric_selection.AdvancedDetectors, {
    setIsValid: setMetricValid
  }), _react.default.createElement(_eui.EuiHorizontalRule, {
    margin: "l"
  }), _react.default.createElement(_settings.AdvancedSettings, {
