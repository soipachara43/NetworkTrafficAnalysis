...
var JobMessagesPane = function JobMessagesPane(_ref) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return _ml_api_service.ml.jobs.jobAuditMessages(jobId);
            ...
            case 10:
              ...
              setIsLoading(false);
              setErrorMessage(_context.t2); // eslint-disable-next-line no-console

              console.error('Job messages could not be loaded', _context.t2);
