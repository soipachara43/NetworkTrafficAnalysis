...
exports.annotationsRefreshed = exports.annotationsRefresh$ = exports.annotation$ = void 0;
...
*/
var annotation$ = new _rxjs.BehaviorSubject(null);
/*
...
var annotationsRefresh$ = new _rxjs.BehaviorSubject(Date.now());
exports.annotationsRefresh$ = annotationsRefresh$;

var annotationsRefreshed = function annotationsRefreshed() {
  return annotationsRefresh$.next(Date.now());
};
