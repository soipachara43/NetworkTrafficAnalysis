...
exports.ClassificationExploration = exports.ExplorationTitle = void 0;
...
var ExplorationTitle = function ExplorationTitle(_ref) {
  ...
  return _react.default.createElement(_eui.EuiTitle, {
    size: "xs"
  }, _react.default.createElement("span", null, _i18n.i18n.translate('xpack.ml.dataframe.analytics.classificationExploration.tableJobIdTitle', {
...
var jobConfigErrorTitle = _i18n.i18n.translate('xpack.ml.dataframe.analytics.classificationExploration.jobConfigurationFetchError', {
  defaultMessage: 'Unable to fetch results. An error occurred loading the job configuration data.'
});

var jobCapsErrorTitle = _i18n.i18n.translate('xpack.ml.dataframe.analytics.classificationExploration.jobCapsFetchError', {
  defaultMessage: "Unable to fetch results. An error occurred loading the index's field data."
});

var ClassificationExploration = function ClassificationExploration(_ref2) {
          ...
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              if (Array.isArray(analyticsConfigs.data_frame_analytics) && analyticsConfigs.data_frame_analytics.length > 0) {
                ...
                setJobConfigErrorMessage(_i18n.i18n.translate('xpack.ml.dataframe.analytics.classificationExploration.jobConfigurationNoResultsMessage', {
