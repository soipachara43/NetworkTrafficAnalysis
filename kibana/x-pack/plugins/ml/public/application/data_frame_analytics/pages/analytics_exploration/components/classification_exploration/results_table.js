...
var _classification_exploration = require("./classification_exploration");
...
var showingDocs = _i18n.i18n.translate('xpack.ml.dataframe.analytics.classificationExploration.documentsShownHelpText', {
  defaultMessage: 'Showing documents for which predictions exist'
});

var showingFirstDocs = _i18n.i18n.translate('xpack.ml.dataframe.analytics.classificationExploration.firstDocumentsShownHelpText', {
...
var ResultsTable = _react.default.memo(function (_ref) {
  ...
  function toggleColumn(column) {
    if (tableItems.length > 0 && jobConfig !== undefined) {
      ...
      setSelectedFields(_toConsumableArray((0, _common.toggleSelectedField)(selectedFields, column, jobConfig.dest.results_field, depVarType)));
    }
  }
    ...
    var render = function render(d, fullItem) {
      ...
      if (Array.isArray(d) && d.every(function (item) {
        ...
        return _react.default.createElement(_eui.EuiToolTip, {
          content: _i18n.i18n.translate('xpack.ml.dataframe.analytics.classificationExploration.indexArrayToolTipContent', {
            defaultMessage: 'The full content of this array based column cannot be displayed.'
          })
        }, _react.default.createElement(_eui.EuiBadge, null, _i18n.i18n.translate('xpack.ml.dataframe.analytics.classificationExploration.indexArrayBadgeContent', {
  ...
  if (status === _common.INDEX_STATUS.ERROR && !errorMessage.includes('parsing_exception')) {
    return _react.default.createElement(_eui.EuiPanel, {
      ...
      grow: false
    }, _react.default.createElement(_classification_exploration.ExplorationTitle, {
      jobId: jobConfig.id
