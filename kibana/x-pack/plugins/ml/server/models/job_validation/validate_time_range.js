...
async function isValidTimeField(callAsCurrentUser, job) {
  ...
  let fieldType = (_fieldCaps$fields$tim = fieldCaps.fields[timeField]) === null || _fieldCaps$fields$tim === void 0 ? void 0 : (_fieldCaps$fields$tim2 = _fieldCaps$fields$tim.date) === null || _fieldCaps$fields$tim2 === void 0 ? void 0 : _fieldCaps$fields$tim2.type;

  if (fieldType === undefined) {
    var _fieldCaps$fields$tim3, _fieldCaps$fields$tim4;

    fieldType = (_fieldCaps$fields$tim3 = fieldCaps.fields[timeField]) === null || _fieldCaps$fields$tim3 === void 0 ? void 0 : (_fieldCaps$fields$tim4 = _fieldCaps$fields$tim3.date_nanos) === null || _fieldCaps$fields$tim4 === void 0 ? void 0 : _fieldCaps$fields$tim4.type;
  }

  return fieldType === _server.ES_FIELD_TYPES.DATE || fieldType === _server.ES_FIELD_TYPES.DATE_NANOS;
}

async function validateTimeRange(callAsCurrentUser, job, timeRange) {
  const messages = [];
