 ...
 */
function fieldsServiceProvider(callAsCurrentUser) {
  ...
  async function getAggregatableFields(index, fieldNames) {
  ...
  async function getCardinalityOfFields(index, fieldNames, query, timeFieldName, earliestMs, latestMs) {
    var _fieldsAggsCache$getV, _ref;
    ...
    const aggregations = (_ref = await callAsCurrentUser('search', {
      index,
      body
    })) === null || _ref === void 0 ? void 0 : _ref.aggregations;
  ...
  async function getMaxBucketCardinalities(index, fieldNames, query, timeFieldName, earliestMs, latestMs, interval) {
    var _fieldsAggsCache$getV2, _ref2;
    ...
    const aggregations = (_ref2 = await callAsCurrentUser('search', {
      index,
      body
    })) === null || _ref2 === void 0 ? void 0 : _ref2.aggregations;
