...
exports.callWithRequestProvider = callWithRequestProvider;
 ...
 */
function callWithRequestProvider(testType) {
  switch (testType) {
...
const fullPrivileges = async (action, params) => {
  switch (action) {
...
const partialPrivileges = async (action, params) => {
  switch (action) {
    case 'ml.privilegeCheck':
      return {
        username: 'test2',
...
const upgradeWithFullPrivileges = async (action, params) => {
  switch (action) {
    case 'ml.privilegeCheck':
      return {
        username: 'elastic',
...
const upgradeWithPartialPrivileges = async (action, params) => {
  switch (action) {
    case 'ml.privilegeCheck':
      return {
        username: 'test2',
