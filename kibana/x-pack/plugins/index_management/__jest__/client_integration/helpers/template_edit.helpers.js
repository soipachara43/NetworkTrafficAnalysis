...
const testBedConfig = {
  memoryRouter: {
    initialEntries: [`${_constants.BASE_PATH}edit_template/${_constants2.TEMPLATE_NAME}`],
    componentRoutePath: `${_constants.BASE_PATH}edit_template/:name`
  },
  doMountAsync: true
};
const initTestBed = (0, _test_utils.registerTestBed)((0, _setup_environment.WithAppDependencies)(_template_edit.TemplateEdit), testBedConfig);
