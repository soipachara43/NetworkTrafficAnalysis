...
exports.getManagedTemplatePrefix = void 0;
...
const getManagedTemplatePrefix = async callAsCurrentUser => {
  try {
    const {
      persistent,
      transient,
...
exports.getManagedTemplatePrefix = getManagedTemplatePrefix;