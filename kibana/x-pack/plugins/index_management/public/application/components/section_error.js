...
var SectionError = function SectionError(_ref) {
  ...
  return _react.default.createElement(_eui.EuiCallOut, _extends({
    ...
    color: "danger",
    iconType: "alert"
  }, rest), _react.default.createElement("div", null, message || statusText), cause && _react.default.createElement(_react.Fragment, null, _react.default.createElement(_eui.EuiSpacer, {
    size: "m"
