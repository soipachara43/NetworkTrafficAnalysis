...
var useStopTransforms = function useStopTransforms() {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                transformsInfo = transforms.map(function (df) {
                  return {
                    id: df.config.id,
                ...
                _context.next = 3;
                return api.stopTransforms(transformsInfo);
                ...
                for (transformId in results) {
                  ...
                  if (results.hasOwnProperty(transformId)) {
                    if (results[transformId].success === true) {
                      toastNotifications.addSuccess(_i18n.i18n.translate('xpack.transform.transformList.stopTransformSuccessMessage', {
