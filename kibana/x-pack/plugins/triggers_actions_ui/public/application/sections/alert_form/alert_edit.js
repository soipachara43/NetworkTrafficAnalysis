...
var AlertEdit = function AlertEdit(_ref) {
  var initialAlert = _ref.initialAlert,
  ...
  var _useState3 = (0, _react.useState)(false),
      ...
      hasActionsDisabled = _useState4[0],
      setHasActionsDisabled = _useState4[1];
  ...
  var alertType = alertTypeRegistry.get(alert.alertTypeId);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return (0, _alert_api.updateAlert)({
                http: http,
                alert: alert,
                id: alert.id
              });
            ...
            case 3:
              ...
              toastNotifications.addSuccess(_i18n.i18n.translate('xpack.triggersActionsUI.sections.alertEdit.saveSuccessNotificationText', {
            ...
            case 8:
              ...
              toastNotifications.addDanger((_ref3 = (_errorRes$body = _context2.t0.body) === null || _errorRes$body === void 0 ? void 0 : _errorRes$body.message) !== null && _ref3 !== void 0 ? _ref3 : _i18n.i18n.translate('xpack.triggersActionsUI.sections.alertEdit.saveErrorNotificationText', {
  ...
  return _react.default.createElement(_eui.EuiPortal, null, _react.default.createElement(_eui.EuiFlyout, {
    ...
    size: "s",
    "data-test-subj": "editAlertFlyoutTitle"
    ...
    label: "Beta",
    tooltipContent: _i18n.i18n.translate('xpack.triggersActionsUI.sections.alertEdit.betaBadgeTooltipContent', {
    ...
    http: http,
    inFlyout: true
  }, _react.default.createElement(_eui.EuiFlyoutBody, null, hasActionsDisabled && _react.default.createElement(_react.Fragment, null, _react.default.createElement(_eui.EuiCallOut, {
    size: "s",
    color: "danger",
    iconType: "alert",
    title: _i18n.i18n.translate('xpack.triggersActionsUI.sections.alertEdit.disabledActionsWarningTitle', {
      defaultMessage: 'This alert has actions that are disabled'
    })
  }), _react.default.createElement(_eui.EuiSpacer, null)), _react.default.createElement(_alert_form.AlertForm, {
    alert: alert,
    dispatch: dispatch,
    errors: errors,
    ...
    onClick: closeFlyout
  }, _i18n.i18n.translate('xpack.triggersActionsUI.sections.alertEdit.cancelButtonLabel', {
