...
function convertConfigSettingsToString(hit) {
  ...
  if ((_config$settings = config.settings) === null || _config$settings === void 0 ? void 0 : _config$settings.transaction_sample_rate) {
    config.settings.transaction_sample_rate = config.settings.transaction_sample_rate.toString();
  }

  if ((_config$settings2 = config.settings) === null || _config$settings2 === void 0 ? void 0 : _config$settings2.transaction_max_spans) {
