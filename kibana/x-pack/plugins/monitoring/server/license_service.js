...
class LicenseService {
  setup({
    ...
    if (!((_rawLicense = rawLicense) === null || _rawLicense === void 0 ? void 0 : _rawLicense.isAvailable)) {
      var _rawLicense2;
    ...
    return {
      ...
      getWatcherFeature: () => {
        ...
        return ((_rawLicense5 = rawLicense) === null || _rawLicense5 === void 0 ? void 0 : _rawLicense5.getFeature('monitoring')) || defaultLicenseFeature;
      },
      getSecurityFeature: () => {
        var _rawLicense6;
