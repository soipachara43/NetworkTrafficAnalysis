...
exports.containerDiskIOBytes = void 0;
 ...
 */
const containerDiskIOBytes = (timeField, indexPattern, interval) => ({
  ...
  series: [{
    ...
    metrics: [{
      ...
      variables: [{
        id: 'var-rate',
        name: 'rate',
        field: 'deriv-max-diskio-read-bytes'
      }],
    ...
    metrics: [{
      ...
      variables: [{
        id: 'var-rate',
        name: 'rate',
        field: 'deriv-max-diskio-write-bytes'
      }],
      script: 'params.rate > 0.0 ? params.rate : 0.0'
    }, {
      id: 'calc-invert-rate',
...
exports.containerDiskIOBytes = containerDiskIOBytes;