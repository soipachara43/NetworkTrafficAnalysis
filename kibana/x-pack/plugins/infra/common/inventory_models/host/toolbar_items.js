...
exports.HostToolbarItems = void 0;
...
const HostToolbarItems = props => {
  const metricTypes = ['cpu', 'memory', 'load', 'rx', 'tx', 'logRate'];
  const groupByFields = ['cloud.availability_zone', 'cloud.machine.type', 'cloud.project.id', 'cloud.provider', 'service.type'];
