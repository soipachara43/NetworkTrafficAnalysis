 ...
 */
var LogEntryCategoriesPageContent = function LogEntryCategoriesPageContent() {
  ...
  var _useLogEntryCategorie = (0, _use_log_entry_categories_module.useLogEntryCategoriesModuleContext)(),
      ...
      fetchModuleDefinition = _useLogEntryCategorie.fetchModuleDefinition,
  ...
  if (isLoadingSource || isUninitialized) {
    ...
    return _react.default.createElement(_page_results_content.LogEntryCategoriesResultsContent, null);
    ...
    return _react.default.createElement(_page_setup_content.LogEntryCategoriesSetupContent, null);
  }
};
