...
exports.logEntryCategoriesModule = void 0;
...
var moduleId = 'logs_ui_categories';

var getJobIds = function getJobIds(spaceId, sourceId) {
  return _log_analysis.logEntryCategoriesJobTypes.reduce(function (accumulatedJobIds, jobType) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _ml_get_jobs_summary_api.callJobsSummaryAPI)(spaceId, sourceId, _log_analysis.logEntryCategoriesJobTypes);
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return (0, _log_analysis2.cleanUpJobsAndDatafeeds)(spaceId, sourceId, _log_analysis.logEntryCategoriesJobTypes);
        ...
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _validate_indices.callValidateIndicesAPI)(indices, [{
              ...
              name: _log_analysis.categoriesMessageField,
              validTypes: ['text']
            }]);
...
var logEntryCategoriesModule = {
  moduleId: moduleId,
  jobTypes: _log_analysis.logEntryCategoriesJobTypes,
  bucketSpan: _log_analysis.bucketSpan,
  getJobIds: getJobIds,
...
exports.logEntryCategoriesModule = logEntryCategoriesModule;