...
var MeasurableItemView =
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(MeasurableItemView, _React$PureComponent);
  ...
  function MeasurableItemView() {
    ...
    _classCallCheck(this, MeasurableItemView);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(MeasurableItemView)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "childRef", React.createRef());

    _defineProperty(_assertThisInitialized(_this), "getOffsetRect", function () {
  ...
  _createClass(MeasurableItemView, [{
