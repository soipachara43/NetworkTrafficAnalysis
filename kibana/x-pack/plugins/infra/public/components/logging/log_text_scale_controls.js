...
function (_React$PureComponent) {
  ...
  function LogTextScaleControls() {
    ...
    _classCallCheck(this, LogTextScaleControls);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(LogTextScaleControls)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "setTextScale", function (textScale) {
  ...
  _createClass(LogTextScaleControls, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
          availableTextScales = _this$props.availableTextScales,
          textScale = _this$props.textScale;
      return React.createElement(_eui.EuiFormRow, {
        ...
        options: availableTextScales.map(function (availableTextScale) {
          return {
