...
exports.filebeatHaproxyRules = void 0;
...
const filebeatHaproxyRules = [{
  ...
  }, ...ecsFrontendFields, ...commonBackendFields, {
    constant: ' "'
  }, {
  ...
  format: [{
    constant: '[HAProxy][http] '
  }, ...preEcsFrontendFields, ...commonBackendFields, {
    constant: ' "'
  }, {
    field: 'haproxy.http.request.raw_request_line'
  }, {
...
exports.filebeatHaproxyRules = filebeatHaproxyRules;