...
exports.filebeatAuditdRules = void 0;
...
const commonOutcomeField = [{
  constant: ' '
}, {
  field: 'event.outcome'
}];
const filebeatAuditdRules = [{
  // ECS format with outcome
  when: {
    exists: ['ecs.version', 'event.action', 'event.outcome', 'auditd.log']
  },
  format: [...commonActionField, ...commonOutcomeField, ...(0, _helpers.labelField)('user', 'user'), ...(0, _helpers.labelField)('process', 'process'), {
    constant: ' '
  }, {
    field: 'auditd.log'
  }, {
  ...
  format: [...commonActionField, ...(0, _helpers.labelField)('user', 'user'), ...(0, _helpers.labelField)('process', 'process'), {
    constant: ' '
  }, {
    field: 'auditd.log'
  }, {
  ...
  when: {
    exists: ['auditd.log.record_type', 'auditd.log.exe', 'auditd.log.gid', 'auditd.log.uid', 'auditd.log.tty', 'auditd.log.pid', 'auditd.log.ppid'],
    values: {
...
exports.filebeatAuditdRules = filebeatAuditdRules;