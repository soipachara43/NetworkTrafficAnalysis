...
exports.initGetLogEntryRateRoute = void 0;
...
const initGetLogEntryRateRoute = ({
  framework,
  ...
  framework.registerRoute({
    ...
    try {
      const payload = (0, _pipeable.pipe)(_log_analysis.getLogEntryRateRequestPayloadRT.decode(request.body), (0, _Either.fold)((0, _runtime_types.throwErrors)(_boom.default.badRequest), _function.identity));
      const logEntryRateBuckets = await logEntryRateAnalysis.getLogEntryRateBuckets(requestContext, request, payload.data.sourceId, payload.data.timeRange.startTime, payload.data.timeRange.endTime, payload.data.bucketDuration);
      return response.ok({
        body: _log_analysis.getLogEntryRateSuccessReponsePayloadRT.encode({
          data: {
...
exports.initGetLogEntryRateRoute = initGetLogEntryRateRoute;

const getTotalNumberOfLogEntries = logEntryRateBuckets => {
