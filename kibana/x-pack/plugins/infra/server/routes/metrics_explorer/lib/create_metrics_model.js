...
exports.createMetricModel = void 0;

var _metrics = require("../../../lib/adapters/metrics");
 ...
 */
const createMetricModel = options => {
  return {
    id: 'custom',
    requires: [],
    ...
    series: options.metrics.map((metric, index) => {
        ...
        return {
          ...
          metrics: [{
            ...
            variables: [{
              id: 'var-rate',
              name: 'rate',
              field: `metric_deriv_${aggType}_${index}`
            }],
      ...
      return {
        ...
        metrics: [{
          ...
          type: _metrics.InfraMetricModelMetricType[aggregation]
        }]
      };
    })
  };
...
exports.createMetricModel = createMetricModel;