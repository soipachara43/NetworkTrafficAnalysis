 ...
 */
const calculateMetricInterval = async (framework, requestContext, options, modules, nodeType) => {
  ...
  const resp = await framework.callWithRequest(requestContext, 'search', query); // if ES doesn't return an aggregations key, something went seriously wrong.
