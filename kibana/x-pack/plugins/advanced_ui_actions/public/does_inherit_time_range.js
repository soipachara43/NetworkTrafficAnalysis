...
exports.doesInheritTimeRange = doesInheritTimeRange;
 ...
 */
function doesInheritTimeRange(embeddable) {
  if (!embeddable.parent) {
    return false;
  }

  var parent = embeddable.parent; // Note: this logic might not work in a container nested world... the explicit input
