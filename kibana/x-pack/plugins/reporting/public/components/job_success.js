 ...
 */
var getSuccessToast = function getSuccessToast(job, getReportLink, getDownloadLink) {
  return {
    ...
    color: 'success',
    text: (0, _public.toMountPoint)(_react.default.createElement(_react.Fragment, null, _react.default.createElement("p", null, _react.default.createElement(_report_link.ReportLink, {
