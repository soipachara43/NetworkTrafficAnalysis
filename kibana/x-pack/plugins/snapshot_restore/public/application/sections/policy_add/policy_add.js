...
var PolicyAdd = function PolicyAdd(_ref) {
  ...
  var indices = _useLoadIndices$data.indices; // Set breadcrumb and page title
  ...
  function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee(newPolicy) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              name = newPolicy.name;
              _context.next = 5;
              return (0, _http.addPolicy)(newPolicy);
  ...
  var emptyPolicy = {
    name: '',
    snapshotName: '',
    schedule: _constants2.DEFAULT_POLICY_SCHEDULE,
    repository: '',
    config: {},
    retention: {
      expireAfterValue: '',
  ...
  return _react.default.createElement(_eui.EuiPageBody, null, _react.default.createElement(_eui.EuiPageContent, null, _react.default.createElement(_eui.EuiTitle, {
    ...
    size: "l"
  }), isLoadingIndices ? _react.default.createElement(_components.SectionLoading, null, _react.default.createElement(_react2.FormattedMessage, {
    id: "xpack.snapshotRestore.addPolicy.loadingIndicesDescription",
    defaultMessage: "Loading available indices\u2026"
  })) : errorLoadingIndices ? _react.default.createElement(_components.SectionError, {
    title: _react.default.createElement(_react2.FormattedMessage, {
  ...
  }) : _react.default.createElement(_components.PolicyForm, {
    policy: emptyPolicy,
    indices: indices,
    currentUrl: pathname,
    isSaving: isSaving,
