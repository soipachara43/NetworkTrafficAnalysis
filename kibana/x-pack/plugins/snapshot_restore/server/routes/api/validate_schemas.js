...
const policySchema = _configSchema.schema.object({
  ...
  modifiedDate: _configSchema.schema.maybe(_configSchema.schema.string()),
  modifiedDateMillis: _configSchema.schema.maybe(_configSchema.schema.number()),
  snapshotName: _configSchema.schema.string(),
  schedule: _configSchema.schema.string(),
  repository: _configSchema.schema.string(),
  nextExecution: _configSchema.schema.maybe(_configSchema.schema.string()),
  nextExecutionMillis: _configSchema.schema.maybe(_configSchema.schema.number()),
  ...
  stats: _configSchema.schema.maybe(_configSchema.schema.object({}, {
    unknowns: 'allow'
  })),
  lastFailure: _configSchema.schema.maybe(_configSchema.schema.object({}, {
    unknowns: 'allow'
  })),
  lastSuccess: _configSchema.schema.maybe(_configSchema.schema.object({}, {
    unknowns: 'allow'
  }))
});
