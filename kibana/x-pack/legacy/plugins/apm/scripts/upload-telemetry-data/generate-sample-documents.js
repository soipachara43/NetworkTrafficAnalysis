...
var _collect_data_telemetry = require("../../../../../plugins/apm/server/lib/apm_telemetry/collect_data_telemetry");
...
async function generateSampleDocuments(options) {
  ...
  return (0, _lodash.flatten)((0, _lodash.range)(0, opts.instances).map(instanceNo => {
