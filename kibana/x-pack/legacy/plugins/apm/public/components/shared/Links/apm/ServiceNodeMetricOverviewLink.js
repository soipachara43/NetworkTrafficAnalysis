...
exports.ServiceNodeMetricOverviewLink = void 0;
...
var ServiceNodeMetricOverviewLink = function ServiceNodeMetricOverviewLink(_ref) {
  var serviceName = _ref.serviceName,
      serviceNodeName = _ref.serviceNodeName,
      rest = _objectWithoutProperties(_ref, ["serviceName", "serviceNodeName"]);
  ...
  return _react.default.createElement(_APMLink.APMLink, _extends({
    path: "/services/".concat(serviceName, "/nodes/").concat(encodeURIComponent(serviceNodeName), "/metrics"),
