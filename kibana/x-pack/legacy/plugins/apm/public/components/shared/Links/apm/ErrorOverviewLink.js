...
exports.ErrorOverviewLink = void 0;
...
var ErrorOverviewLink = function ErrorOverviewLink(_ref) {
  var serviceName = _ref.serviceName,
      query = _ref.query,
      rest = _objectWithoutProperties(_ref, ["serviceName", "query"]);
  ...
  return _react.default.createElement(_APMLink.APMLink, _extends({
    path: "/services/".concat(serviceName, "/errors"),
    query: _objectSpread({}, persistedFilters, {}, query)
  }, rest));
};

exports.ErrorOverviewLink = ErrorOverviewLink;