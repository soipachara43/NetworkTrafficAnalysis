...
exports.TransactionDetailLink = void 0;
...
var TransactionDetailLink = function TransactionDetailLink(_ref) {
  var serviceName = _ref.serviceName,
      ...
      rest = _objectWithoutProperties(_ref, ["serviceName", "traceId", "transactionId", "transactionName", "transactionType"]);

  var _useUrlParams = (0, _useUrlParams2.useUrlParams)(),
      urlParams = _useUrlParams.urlParams;

  var persistedFilters = (0, _pickKeys.pickKeys)(urlParams, 'transactionResult', 'serviceVersion');
  return _react.default.createElement(_APMLink.APMLink, _extends({
    path: "/services/".concat(serviceName, "/transactions/view"),
    query: _objectSpread({
      traceId: traceId,
