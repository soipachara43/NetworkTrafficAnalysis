...
exports.getChromeLogLocation = exports.paths = void 0;
 ...
 */
const paths = {
  archivesPath: _path.default.resolve(__dirname, '../../../.chromium'),
...
const getChromeLogLocation = binaryPath => _path.default.join(binaryPath, '..', 'chrome_debug.log');

exports.getChromeLogLocation = getChromeLogLocation;