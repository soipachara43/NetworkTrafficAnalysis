...
exports.checkLicenseFactory = checkLicenseFactory;
...
const makeManagementFeature = exportTypes => {
  return {
    ...
    checkLicense: license => {
      ...
      const validJobTypes = exportTypes.filter(exportType => license.isOneOf(exportType.validLicenses)).map(exportType => exportType.jobType);
      return {
...
function checkLicenseFactory(exportTypesRegistry) {
  return function checkLicense(xpackInfo) {
