...
function () {
  function DataRequest(descriptor) {
    ...
    this._descriptor = _objectSpread({}, descriptor);
  }
  ...
  _createClass(DataRequest, [{
    ...
    value: function getMeta() {
      return this.hasData() ? _lodash.default.get(this._descriptor, 'dataMeta', {}) : _lodash.default.get(this._descriptor, 'dataMetaAtStart', {});
    }
  }, {
    key: "hasData",
...
var DataRequestAbortError =
/*#__PURE__*/
function (_Error) {
  _inherits(DataRequestAbortError, _Error);

  function DataRequestAbortError() {
    _classCallCheck(this, DataRequestAbortError);

    return _possibleConstructorReturn(this, _getPrototypeOf(DataRequestAbortError).call(this));
  }

  return DataRequestAbortError;
