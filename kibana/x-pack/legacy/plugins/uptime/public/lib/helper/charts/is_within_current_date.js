...
exports.isWithinCurrentDate = void 0;
 ...
 */
var isWithinCurrentDate = function isWithinCurrentDate(dateRangeStart, dateRangeEnd) {
  var today = new Date(Date.now());
  var min = today.setHours(0, 0, 0, 0).valueOf();
  var max = today.setHours(23, 59, 59, 999).valueOf();
  return dateRangeStart > min && dateRangeStart < max && dateRangeEnd < max;
};

exports.isWithinCurrentDate = isWithinCurrentDate;