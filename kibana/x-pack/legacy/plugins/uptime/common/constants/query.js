...
exports.STATES = exports.QUERY = void 0;
...
const QUERY = {
  ...
  SIMPLE_QUERY_STRING_FIELDS: ['monitor.id', 'monitor.url', 'monitor.type', 'monitor.status', 'monitor.name', 'url.full', 'url.path', 'url.scheme', 'url.domain', 'error.type']
};
exports.QUERY = QUERY;
const STATES = {
