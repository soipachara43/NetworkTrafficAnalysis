...
exports.NodeAxiosAPIAdapter = void 0;
...
var pkg = JSON.parse(_fs.default.readFileSync((0, _path.resolve)((0, _path.join)(__dirname, '../../../../../../../../package.json'))).toString());
var globalAPI;

var NodeAxiosAPIAdapter =
/*#__PURE__*/
function () {
  function NodeAxiosAPIAdapter(username, password, basePath) {
    _classCallCheck(this, NodeAxiosAPIAdapter);
  ...
  _createClass(NodeAxiosAPIAdapter, [{
    key: "get",
    value: function () {
