 ...
 */
var MemoryTokensAdapter =
/*#__PURE__*/
function () {
  function MemoryTokensAdapter() {
    _classCallCheck(this, MemoryTokensAdapter);
  }

  _createClass(MemoryTokensAdapter, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", ['2jnwkrhkwuehriauhweair']);
