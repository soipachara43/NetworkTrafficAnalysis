 ...
 */
var NoAccessPage = (0, _react.injectI18n)(function (_ref) {
  var intl = _ref.intl;
  return React.createElement(_no_data.NoDataLayout, {
    ...
    defaultMessage: "You are not authorized to access Beats central management. To use Beats central management, you need the privileges granted by the {beatsAdminRole} role.",
    values: {
      beatsAdminRole: '`beats_admin`'
    }
  })));
});
