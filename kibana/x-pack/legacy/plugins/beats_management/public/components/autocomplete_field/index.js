...
function (_React$Component) {
  ...
  function AutocompleteField() {
      ...
      switch (evt.key) {
        case 'ArrowUp':
          ...
          if (suggestions.length > 0) {
            _this.setState((0, _typed_react.composeStateUpdaters)(withSuggestionsVisible, withPreviousSuggestionSelected));
          }
        ...
        case 'ArrowDown':
          ...
          if (suggestions.length > 0) {
            _this.setState((0, _typed_react.composeStateUpdaters)(withSuggestionsVisible, withNextSuggestionSelected));
          } else {
    ...
    _defineProperty(_assertThisInitialized(_this), "hideSuggestions", function () {
      _this.setState(withSuggestionsHidden);
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "updateSuggestions", function (value) {
  ...
  _createClass(AutocompleteField, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_eui.EuiOutsideClickDetector, {
        onOutsideClick: this.hideSuggestions
...
var FixedEuiFieldSearch = _eui.EuiFieldSearch;

var AutocompleteContainer = _styledComponents.default.div.withConfig({
  displayName: "AutocompleteContainer",
  componentId: "sc-6npntb-0"
})(["position:relative;"]);

var SuggestionsPanel = (0, _styledComponents.default)(_eui.EuiPanel).attrs(function () {
  return {
    paddingSize: 'none',
    hasShadow: true
  };
}).withConfig({
  displayName: "SuggestionsPanel",
  componentId: "sc-6npntb-1"
})(["position:absolute;width:100%;margin-top:2px;overflow:hidden;z-index:1000;"]);