...
exports.FormsyEuiMultiFieldText = void 0;
...
/*#__PURE__*/
function (_Component) {
  _inherits(MultiFieldText, _Component);

  function MultiFieldText() {
    var _getPrototypeOf2;

    var _this;

    _classCallCheck(this, MultiFieldText);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(MultiFieldText)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  return MultiFieldText;
}(_react.Component);

_defineProperty(MultiFieldText, "defaultProps", {
  passRequiredToField: true
});

var FormsyEuiMultiFieldText = (0, _formsyReact.withFormsy)(MultiFieldText);
exports.FormsyEuiMultiFieldText = FormsyEuiMultiFieldText;