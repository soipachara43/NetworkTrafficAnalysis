...
exports.auditbeatSchema = void 0;
  ...
  fields: [{
    ...
    fields: [{
      ...
      fields: [{
        name: 'entity_id',
        type: 'keyword',
        description: 'ID uniquely identifying the package. It is computed as a SHA-256 hash of the  host ID, package name, and package version.\n'
      }, {
        name: 'name',
        type: 'keyword',
        description: 'Package name.\n'
...
exports.auditbeatSchema = auditbeatSchema;