...
exports.mockOptions = exports.mockResponse = exports.mockRequest = exports.expectedTlsEdges = exports.mockTlsQuery = void 0;
...
exports.mockTlsQuery = mockTlsQuery;
const expectedTlsEdges = [{
  cursor: {
    tiebreaker: null,
  ...
  cursor: {
    tiebreaker: null,
    value: 'fcdc16645ebb3386adc96e7ba735c4745709b9dd'
  },
  node: {
  ...
  cursor: {
    tiebreaker: null,
    value: 'fccf375789cb7e671502a7b0cc969f218a4b2c70'
  },
  node: {
  ...
  cursor: {
    tiebreaker: null,
    value: 'fc4a296b706fa18ac50b96f5c0327c69db4a8981'
  },
  node: {
  ...
  cursor: {
    tiebreaker: null,
    value: 'fc2cbc41f6a0e9c0118de4fe40f299f7207b797e'
  },
  node: {
  ...
  cursor: {
    tiebreaker: null,
    value: 'fb70d78ffa663a3a4374d841b3288d2de9759566'
  },
  node: {
  ...
  cursor: {
    tiebreaker: null,
    value: 'fb59038dcec33ab3a01a6ae60d0835ad0e04ccf0'
  },
  node: {
  ...
  cursor: {
    tiebreaker: null,
    value: 'f9815293c883a6006f0b2d95a4895bdc501fd174'
  },
  node: {
  ...
  cursor: {
    tiebreaker: null,
    value: 'f8db6a69797e383dca2529727369595733123386'
  },
  node: {
...
exports.expectedTlsEdges = expectedTlsEdges;
const mockRequest = {
  body: {
    ...
    query: 'query GetTlsQuery($sourceId: ID!, $filterQuery: String, $flowTarget: FlowTarget!, $ip: String!, $pagination: PaginationInputPaginated!, $sort: TlsSortField!, $timerange: TimerangeInput!, $defaultIndex: [String!]!, $inspect: Boolean!) {\n  source(id: $sourceId) {\n    id\n    Tls(filterQuery: $filterQuery, flowTarget: $flowTarget, ip: $ip, pagination: $pagination, sort: $sort, timerange: $timerange, defaultIndex: $defaultIndex) {\n      totalCount\n      edges {\n        node {\n          _id\n          subjects\n          ja3\n          issuers\n          notAfter\n          __typename\n        }\n        cursor {\n          value\n          __typename\n        }\n        __typename\n      }\n      pageInfo {\n        activePage\n        fakeTotalCount\n        showMorePagesIndicator\n        __typename\n      }\n      inspect @include(if: $inspect) {\n        dsl\n        response\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n'
  }
};
    ...
    sha1: {
      ...
      buckets: [{
        ...
        not_after: {
          ...
          buckets: [{
            key: 1572177600000,
            key_as_string: '2019-10-27T12:00:00.000Z',
            doc_count: 1
          }]
        },
        issuers: {
          ...
          sum_other_doc_count: 0,
          buckets: [{
            key: 'DigiCert SHA2 Secure Server CA',
            doc_count: 1
          }]
        },
        subjects: {
        ...
        ja3: {
          ...
          sum_other_doc_count: 0,
          buckets: [{
            key: '95d2dd53a89b334cddd5c22e81e7fe61',
            doc_count: 1
          }]
        }
      }, {
        ...
        not_after: {
          ...
          buckets: [{
            key: 1580558400000,
            key_as_string: '2020-02-01T12:00:00.000Z',
            doc_count: 1
          }]
        },
        issuers: {
        ...
        ja3: {
          ...
          sum_other_doc_count: 0,
          buckets: [{
            key: 'a111d93cdf31f993c40a8a9ef13e8d7e',
            doc_count: 1
          }]
        }
      }, {
        ...
        not_after: {
          ...
          buckets: [{
            key: 1583531829000,
            key_as_string: '2020-03-06T21:57:09.000Z',
            doc_count: 1
          }]
        },
        issuers: {
          ...
          sum_other_doc_count: 0,
          buckets: [{
            key: 'Trustwave Organization Validation SHA256 CA, Level 1',
            doc_count: 1
          }]
        },
        subjects: {
          ...
          sum_other_doc_count: 0,
          buckets: [{
            key: 'player-devintever2.mountain.siriusxm.com',
            doc_count: 1
          }]
        },
        ja3: {
          ...
          sum_other_doc_count: 0,
          buckets: [{
            key: '6fa3244afc6bb6f9fad207b6b52af26b',
            doc_count: 1
          }]
        }
      }, {
        ...
        issuers: {
          ...
          sum_other_doc_count: 0,
          buckets: [{
            key: 'DigiCert SHA2 Extended Validation Server CA',
            doc_count: 1
          }]
        },
        subjects: {
        ...
        not_after: {
          ...
          buckets: [{
            key: 1585051200000,
            key_as_string: '2020-03-24T12:00:00.000Z',
            doc_count: 2
          }]
        },
        issuers: {
        ...
        ja3: {
          ...
          sum_other_doc_count: 0,
          buckets: [{
            key: 'a441a33aaee795f498d6b764cc78989a',
            doc_count: 2
          }]
        }
      }, {
        ...
        not_after: {
          ...
          buckets: [{
            key: 1586009106000,
            key_as_string: '2020-04-04T14:05:06.000Z',
            doc_count: 1
          }]
        },
        issuers: {
          ...
          sum_other_doc_count: 0,
          buckets: [{
            key: 'GlobalSign CloudSSL CA - SHA256 - G3',
            doc_count: 1
          }]
        },
        subjects: {
        ...
        not_after: {
          ...
          buckets: [{
            key: 1635336000000,
            key_as_string: '2021-10-27T12:00:00.000Z',
            doc_count: 325
          }]
        },
        issuers: {
          ...
          sum_other_doc_count: 0,
          buckets: [{
            key: 'DigiCert Baltimore CA-2 G2',
            doc_count: 325
          }]
        },
        subjects: {
        ...
        ja3: {
          ...
          sum_other_doc_count: 0,
          buckets: [{
            key: '535aca3d99fc247509cd50933cd71d37',
            doc_count: 284
          }, {
            key: '6fa3244afc6bb6f9fad207b6b52af26b',
            doc_count: 39
        ...
        not_after: {
          ...
          buckets: [{
            key: 1587643200000,
            key_as_string: '2020-04-23T12:00:00.000Z',
            doc_count: 5
          }]
        },
        issuers: {
        ...
        not_after: {
          ...
          buckets: [{
            key: 1613001599000,
            key_as_string: '2021-02-10T23:59:59.000Z',
            doc_count: 29
          }]
        },
        issuers: {
          ...
          sum_other_doc_count: 0,
          buckets: [{
            key: 'Sectigo RSA Organization Validation Secure Server CA',
            doc_count: 29
          }]
        },
        subjects: {
        ...
        not_after: {
          ...
          buckets: [{
            key: 1575984774000,
            key_as_string: '2019-12-10T13:32:54.000Z',
            doc_count: 5
          }]
        },
        issuers: {
...
const mockOptions = {
  ...
  filterQuery: {},
  fields: ['totalCount', '_id', 'subjects', 'ja3', 'issuers', 'notAfter', 'edges.cursor.value', 'pageInfo.activePage', 'pageInfo.fakeTotalCount', 'pageInfo.showMorePagesIndicator', 'inspect.dsl', 'inspect.response'],
  ip: '',
  sort: {
