...
var _export_rules_schema = require("../schemas/export_rules_schema");
...
const exportRulesRoute = (router, config) => {
  router.post({
    ...
    validate: {
      query: (0, _utils.buildRouteValidation)(_export_rules_schema.exportRulesQuerySchema),
      body: (0, _utils.buildRouteValidation)(_export_rules_schema.exportRulesSchema)
    },
    options: {
      tags: ['access:siem']
    }
