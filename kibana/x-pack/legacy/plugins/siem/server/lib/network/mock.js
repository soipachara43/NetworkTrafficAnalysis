...
exports.mockResultIp = exports.mockResponseIp = exports.mockRequestIp = exports.mockOptionsIp = exports.mockResult = exports.mockTopNFlowQueryDsl = exports.mockResponse = exports.mockRequest = exports.mockOptions = void 0;
...
const mockOptions = {
  ...
  filterQuery: {},
  fields: ['totalCount', 'source.ip', 'source.domain', 'source.__typename', 'destination.ip', 'destination.domain', 'destination.__typename', 'event.duration', 'event.__typename', 'network.bytes_in', 'network.bytes_out', 'network.__typename', '__typename', 'edges.cursor.value', 'edges.cursor.__typename', 'edges.__typename', 'pageInfo.activePage', 'pageInfo.__typename', 'pageInfo.fakeTotalCount', 'pageInfo.__typename', 'pageInfo.showMorePagesIndicator', 'pageInfo.__typename', '__typename'],
  networkTopNFlowSort: {
...
const mockResponse = {
  ...
  aggregations: {
    ...
    [_types.FlowTargetSourceDest.source]: {
      buckets: [{
        key: '1.1.1.1',
        flows: {
          value: 1234567
...
const mockTopNFlowQueryDsl = {
  mockTopNFlowQueryDsl: 'mockTopNFlowQueryDsl'
};
exports.mockTopNFlowQueryDsl = mockTopNFlowQueryDsl;
const mockResult = {
  inspect: {
...
const mockOptionsIp = { ...mockOptions,
  ip: '1.1.1.1'
};
exports.mockOptionsIp = mockOptionsIp;
const mockRequestIp = { ...mockRequest,
  body: { ...mockRequest.body,
    variables: { ...mockRequest.body.variables,
      ip: '1.1.1.1'
    }
  }
};
exports.mockRequestIp = mockRequestIp;
const mockResponseIp = {
  took: 122,
  timed_out: false,
  _shards: {
    total: 1,
...
exports.mockResponseIp = mockResponseIp;
const mockResultIp = {
  inspect: {
    dsl: [JSON.stringify(mockTopNFlowQueryDsl, null, 2)],
...
exports.mockResultIp = mockResultIp;