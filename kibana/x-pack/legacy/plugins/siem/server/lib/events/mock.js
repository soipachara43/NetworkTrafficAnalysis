...
exports.mockTimelineDetailsResult = exports.mockQueryDsl = exports.mockDetailsQueryDsl = exports.mockResponseMap = exports.mockRequest = exports.mockOptions = exports.mockResponseSearchTimelineDetails = void 0;
 ...
 */
const mockResponseSearchTimelineDetails = {
  took: 5,
  timed_out: false,
  _shards: {
    total: 1,
    ...
    hits: [{
      ...
      _source: {
        ...
        process: {
          ...
          pid: 15990,
          ppid: 1,
          title: '/root/go/src/github.com/elastic/beats/x-pack/auditbeat/auditbeat -e -c /root/go/src/github.com/elastic/beats/x-pack/auditbeat/au',
          name: 'auditbeat'
        },
        host: {
          architecture: 'x86_64',
        ...
        event: {
          category: 'audit-rule',
          action: 'opened-file',
          original: ['type=SYSCALL msg=audit(1553886083.420:8817905): arch=c000003e syscall=257 success=yes exit=12 a0=ffffff9c a1=7fe0f63df220 a2=80000 a3=0 items=1 ppid=1 pid=15990 auid=4294967295 uid=0 gid=0 euid=0 suid=0 fsuid=0 egid=0 sgid=0 fsgid=0 tty=(none) ses=4294967295 comm="auditbeat" exe="/root/go/src/github.com/elastic/beats/x-pack/auditbeat/auditbeat" key=(null)', 'type=CWD msg=audit(1553886083.420:8817905): cwd="/root/go/src/github.com/elastic/beats/x-pack/auditbeat"', 'type=PATH msg=audit(1553886083.420:8817905): item=0 name="/etc/passwd" inode=3926 dev=fc:01 mode=0100644 ouid=0 ogid=0 rdev=00:00 nametype=NORMAL cap_fp=0000000000000000 cap_fi=0000000000000000 cap_fe=0 cap_fver=0', 'type=PROCTITLE msg=audit(1553886083.420:8817905): proctitle='],
          module: 'auditd'
        },
        ecs: {
          version: '1.0.0'
...
exports.mockResponseSearchTimelineDetails = mockResponseSearchTimelineDetails;
const mockOptions = {
...
exports.mockResponseMap = mockResponseMap;
const mockDetailsQueryDsl = {
  mockDetailsQueryDsl: 'mockDetailsQueryDsl'
};
exports.mockDetailsQueryDsl = mockDetailsQueryDsl;
const mockQueryDsl = {
  mockQueryDsl: 'mockQueryDsl'
};
exports.mockQueryDsl = mockQueryDsl;
const mockTimelineDetailsInspectResponse = (0, _fp.cloneDeep)(mockResponseSearchTimelineDetails);
delete mockTimelineDetailsInspectResponse.hits.hits[0]._source;
const mockTimelineDetailsResult = {
  inspect: {
  ...
  data: [{
    ...
    category: 'process',
    field: 'process.title',
    values: '/root/go/src/github.com/elastic/beats/x-pack/auditbeat/auditbeat -e -c /root/go/src/github.com/elastic/beats/x-pack/auditbeat/au',
    originalValue: '/root/go/src/github.com/elastic/beats/x-pack/auditbeat/auditbeat -e -c /root/go/src/github.com/elastic/beats/x-pack/auditbeat/au'
  }, {
    category: 'process',
    field: 'process.name',
    values: 'auditbeat',
...
exports.mockTimelineDetailsResult = mockTimelineDetailsResult;