...
exports.getMockNetflowData = void 0;

var _helpers = require("../components/formatted_duration/helpers");
...
var getMockNetflowData = function getMockNetflowData() {
  return {
    destination: {
      bytes: [40],
      geo: {
    ...
    event: {
      ...
      duration: [_helpers.ONE_MILLISECOND_AS_NANOSECONDS],
...
exports.getMockNetflowData = getMockNetflowData;