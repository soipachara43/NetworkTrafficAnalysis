 ...
 */
var ID = 'kpiHostsQuery';

var KpiHostsComponentQuery = _react.default.memo(function (_ref) {
  var _ref$id = _ref.id,
  ...
  return _react.default.createElement(_reactApollo.Query, {
    ...
    var kpiHosts = (0, _fp.getOr)({}, "source.KpiHosts", data);
    return children({
      id: id,
      inspect: (0, _fp.getOr)(null, 'source.KpiHosts.inspect', data),
      kpiHosts: kpiHosts,
      loading: loading,
      refetch: refetch
    });
...
var KpiHostsQuery = connector(KpiHostsComponentQuery);
