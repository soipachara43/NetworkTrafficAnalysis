...
exports.mockUserPrivilege = exports.mockSignalIndex = exports.mockStatusSignalQuery = exports.mockSignalsQuery = exports.signalsMock = void 0;
  ...
  hits: {
    ...
    hits: [{
      ...
      _source: {
        ...
        signal: {
          ...
          rule: {
            ...
            severity: 'high',
            tags: ['host.name exists', 'for testing', '__internal_rule_id:82b2b065-a2ee-49fc-9d6d-781a75c3d280', '__internal_immutable:false'],
            type: 'query',
            to: 'now',
            enabled: true,
            filters: [],
      ...
      _source: {
        ...
        message: 'ERROR for PID 317759: failed to hash executable / for PID 317759: failed to calculate file hashes: read /: is a directory',
        cloud: {
          instance: {
            id: '5167639562480685129',
            name: 'beats-ci-immutable-ubuntu-1604-1581723302100990071'
        ...
        error: {
          message: 'failed to hash executable / for PID 317759: failed to calculate file hashes: read /: is a directory'
        },
        process: {
...
exports.signalsMock = signalsMock;
var mockSignalsQuery = {
  aggs: {
    signalsByGrouping: {
      terms: {
...
exports.mockSignalsQuery = mockSignalsQuery;
var mockStatusSignalQuery = {
  bool: {
    filter: {
      terms: {
        _id: ['b4ee5c32e3a321057edcc953ca17228c6fdfe5ba43fdbbdaffa8cefa11605cc5']
      }
    }
  }
};
exports.mockStatusSignalQuery = mockStatusSignalQuery;
var mockSignalIndex = {
  name: 'mock-signal-index'
};
exports.mockSignalIndex = mockSignalIndex;
var mockUserPrivilege = {
  username: 'elastic',
...
exports.mockUserPrivilege = mockUserPrivilege;