...
var ID = 'networkTopNFlowQuery';

var NetworkTopNFlowComponentQuery =
/*#__PURE__*/
function (_QueryTemplatePaginat) {
  _inherits(NetworkTopNFlowComponentQuery, _QueryTemplatePaginat);

  function NetworkTopNFlowComponentQuery() {
    _classCallCheck(this, NetworkTopNFlowComponentQuery);

    return _possibleConstructorReturn(this, _getPrototypeOf(NetworkTopNFlowComponentQuery).apply(this, arguments));
  }

  _createClass(NetworkTopNFlowComponentQuery, [{
    key: "render",
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          id = _this$props$id === void 0 ? "".concat(ID, "-").concat(flowTarget) : _this$props$id,
          ip = _this$props.ip,
      ...
      return _react.default.createElement(_reactApollo.Query, {
        ...
        query: _index.networkTopNFlowQuery,
        skip: skip,
        variables: variables
      }, function (_ref) {
        var data = _ref.data,
        ...
        var networkTopNFlow = (0, _fp.getOr)([], "source.NetworkTopNFlow.edges", data);
            ...
            updateQuery: function updateQuery(prev, _ref2) {
              ...
              return _objectSpread({}, fetchMoreResult, {
                source: _objectSpread({}, fetchMoreResult.source, {
                  NetworkTopNFlow: _objectSpread({}, fetchMoreResult.source.NetworkTopNFlow, {
                    edges: _toConsumableArray(fetchMoreResult.source.NetworkTopNFlow.edges)
                  })
                })
              });
            }
        ...
        return children({
          id: id,
          inspect: (0, _fp.getOr)(null, 'source.NetworkTopNFlow.inspect', data),
          isInspected: isInspected,
          loading: isLoading,
          loadPage: _this.wrappedLoadMore,
          networkTopNFlow: networkTopNFlow,
          pageInfo: (0, _fp.getOr)({}, 'source.NetworkTopNFlow.pageInfo', data),
          refetch: _this.memoizedRefetchQuery(variables, limit, refetch),
          totalCount: (0, _fp.getOr)(-1, 'source.NetworkTopNFlow.totalCount', data)
        });
      });
    }
  }]);

  return NetworkTopNFlowComponentQuery;
}(_query_template_paginated.QueryTemplatePaginated);

var makeMapStateToProps = function makeMapStateToProps() {
  var getTopNFlowSelector = _store.networkSelectors.topNFlowSelector();
  ...
  return function (state, _ref3) {
    var flowTarget = _ref3.flowTarget,
        _ref3$id = _ref3.id,
        id = _ref3$id === void 0 ? "".concat(ID, "-").concat(flowTarget) : _ref3$id,
        type = _ref3.type;

    var _getQuery = getQuery(state, id),
        isInspected = _getQuery.isInspected;

    return _objectSpread({}, getTopNFlowSelector(state, type, flowTarget), {
      isInspected: isInspected
    });
  };
};

var NetworkTopNFlowQuery = (0, _redux.compose)((0, _reactRedux.connect)(makeMapStateToProps), _kibana.withKibana)(NetworkTopNFlowComponentQuery);
