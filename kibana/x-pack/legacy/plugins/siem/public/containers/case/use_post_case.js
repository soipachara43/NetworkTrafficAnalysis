  ...
  switch (action.type) {
    ...
    case 'FETCH_SUCCESS':
      return _objectSpread({}, state, {
        isLoading: false,
        isError: false,
        caseData: (_action$payload = action.payload) !== null && _action$payload !== void 0 ? _action$payload : null
      });
...
var usePostCase = function usePostCase() {
  ...
  var postMyCase = (0, _react.useCallback)(
  /*#__PURE__*/
  function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 6;
              return (0, _api.postCase)(data, abortCtrl.signal);
...
exports.usePostCase = usePostCase;