...
var useGetActionLicense = function useGetActionLicense() {
  var _useState = (0, _react.useState)(initialData),
      _useState2 = _slicedToArray(_useState, 2),
      actionLicenseState = _useState2[0],
      setActionLicensesState = _useState2[1];
  ...
  var fetchActionLicense = (0, _react.useCallback)(function () {
    var didCancel = false;
    ...
    function () {
      ...
      regeneratorRuntime.mark(function _callee() {
        var response, _response$find;

        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                setActionLicensesState(_objectSpread({}, actionLicenseState, {
                  isLoading: true
                }));
                _context.prev = 1;
                _context.next = 4;
                return (0, _api.getActionLicense)(abortCtrl.signal);
              ...
              case 4:
                ...
                if (!didCancel) {
                  setActionLicensesState({
                    actionLicense: (_response$find = response.find(function (l) {
                      return l.id === '.servicenow';
                    })) !== null && _response$find !== void 0 ? _response$find : null,
                    isLoading: false,
                    isError: false
                  });
                }
  ...
  return _objectSpread({}, actionLicenseState);
};
