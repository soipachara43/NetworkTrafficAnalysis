...
var ID = 'networkTopCountriesQuery';
...
function (_QueryTemplatePaginat) {
  ...
  function NetworkTopCountriesComponentQuery() {
    _classCallCheck(this, NetworkTopCountriesComponentQuery);

    return _possibleConstructorReturn(this, _getPrototypeOf(NetworkTopCountriesComponentQuery).apply(this, arguments));
  }

  _createClass(NetworkTopCountriesComponentQuery, [{
    key: "render",
    value: function render() {
      ...
      return _react.default.createElement(_reactApollo.Query, {
        ...
        query: _index.networkTopCountriesQuery,
        skip: skip,
        variables: variables
      }, function (_ref) {
        var data = _ref.data,
        ...
        var networkTopCountries = (0, _fp.getOr)([], "source.NetworkTopCountries.edges", data);
            ...
            updateQuery: function updateQuery(prev, _ref2) {
              ...
              return _objectSpread({}, fetchMoreResult, {
                source: _objectSpread({}, fetchMoreResult.source, {
                  NetworkTopCountries: _objectSpread({}, fetchMoreResult.source.NetworkTopCountries, {
                    edges: _toConsumableArray(fetchMoreResult.source.NetworkTopCountries.edges)
                  })
                })
              });
            }
        ...
        return children({
          id: id,
          inspect: (0, _fp.getOr)(null, 'source.NetworkTopCountries.inspect', data),
          isInspected: isInspected,
          loading: isLoading,
          loadPage: _this.wrappedLoadMore,
          networkTopCountries: networkTopCountries,
          pageInfo: (0, _fp.getOr)({}, 'source.NetworkTopCountries.pageInfo', data),
          refetch: _this.memoizedRefetchQuery(variables, limit, refetch),
          totalCount: (0, _fp.getOr)(-1, 'source.NetworkTopCountries.totalCount', data)
        });
      });
    }
  }]);

  return NetworkTopCountriesComponentQuery;
...
var makeMapStateToProps = function makeMapStateToProps() {
  ...
  return function (state, _ref3) {
    ...
    return _objectSpread({}, getTopCountriesSelector(state, type, flowTarget), {
      isInspected: isInspected
    });
  };
};

var NetworkTopCountriesQuery = (0, _redux.compose)((0, _reactRedux.connect)(makeMapStateToProps), _kibana.withKibana)(NetworkTopCountriesComponentQuery);
