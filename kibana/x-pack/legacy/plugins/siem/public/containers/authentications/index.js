...
var ID = 'authenticationQuery';

var AuthenticationsComponentQuery =
/*#__PURE__*/
function (_QueryTemplatePaginat) {
  _inherits(AuthenticationsComponentQuery, _QueryTemplatePaginat);

  function AuthenticationsComponentQuery() {
    _classCallCheck(this, AuthenticationsComponentQuery);

    return _possibleConstructorReturn(this, _getPrototypeOf(AuthenticationsComponentQuery).apply(this, arguments));
  }

  _createClass(AuthenticationsComponentQuery, [{
    key: "render",
    value: function render() {
      ...
      return _react.default.createElement(_reactApollo.Query, {
        query: _index.authenticationsQuery,
        ...
        var authentications = (0, _fp.getOr)([], 'source.Authentications.edges', data);
            ...
            updateQuery: function updateQuery(prev, _ref2) {
              ...
              return _objectSpread({}, fetchMoreResult, {
                source: _objectSpread({}, fetchMoreResult.source, {
                  Authentications: _objectSpread({}, fetchMoreResult.source.Authentications, {
                    edges: _toConsumableArray(fetchMoreResult.source.Authentications.edges)
                  })
                })
              });
            }
        ...
        return children({
          ...
          id: id,
          inspect: (0, _fp.getOr)(null, 'source.Authentications.inspect', data),
          isInspected: isInspected,
          loading: isLoading,
          loadPage: _this.wrappedLoadMore,
          pageInfo: (0, _fp.getOr)({}, 'source.Authentications.pageInfo', data),
          refetch: _this.memoizedRefetchQuery(variables, limit, refetch),
          totalCount: (0, _fp.getOr)(-1, 'source.Authentications.totalCount', data)
        });
      });
    }
  }]);

  return AuthenticationsComponentQuery;
...
var makeMapStateToProps = function makeMapStateToProps() {
  ...
  var mapStateToProps = function mapStateToProps(state, _ref3) {
    ...
    return _objectSpread({}, getAuthenticationsSelector(state, type), {
      isInspected: isInspected
    });
  };
...
var AuthenticationsQuery = (0, _redux.compose)((0, _reactRedux.connect)(makeMapStateToProps), _kibana.withKibana)(AuthenticationsComponentQuery);
