...
var UsersComponentQuery =
/*#__PURE__*/
function (_QueryTemplatePaginat) {
  _inherits(UsersComponentQuery, _QueryTemplatePaginat);

  function UsersComponentQuery() {
    _classCallCheck(this, UsersComponentQuery);

    return _possibleConstructorReturn(this, _getPrototypeOf(UsersComponentQuery).apply(this, arguments));
  }

  _createClass(UsersComponentQuery, [{
    key: "render",
    value: function render() {
      ...
      return _react.default.createElement(_reactApollo.Query, {
        ...
        var users = (0, _fp.getOr)([], "source.Users.edges", data);
            ...
            updateQuery: function updateQuery(prev, _ref2) {
              ...
              return _objectSpread({}, fetchMoreResult, {
                source: _objectSpread({}, fetchMoreResult.source, {
                  Users: _objectSpread({}, fetchMoreResult.source.Users, {
                    edges: _toConsumableArray(fetchMoreResult.source.Users.edges)
                  })
                })
              });
            }
        ...
        return children({
          id: id,
          inspect: (0, _fp.getOr)(null, 'source.Users.inspect', data),
          isInspected: isInspected,
          loading: isLoading,
          loadPage: _this.wrappedLoadMore,
          pageInfo: (0, _fp.getOr)({}, 'source.Users.pageInfo', data),
          refetch: _this.memoizedRefetchQuery(variables, limit, refetch),
          totalCount: (0, _fp.getOr)(-1, 'source.Users.totalCount', data),
          users: users
        });
      });
    }
...
var UsersQuery = (0, _redux.compose)(connector, _kibana.withKibana)(UsersComponentQuery);
