...
var ID = 'networkHttpQuery';

var NetworkHttpComponentQuery =
/*#__PURE__*/
function (_QueryTemplatePaginat) {
  _inherits(NetworkHttpComponentQuery, _QueryTemplatePaginat);

  function NetworkHttpComponentQuery() {
    _classCallCheck(this, NetworkHttpComponentQuery);

    return _possibleConstructorReturn(this, _getPrototypeOf(NetworkHttpComponentQuery).apply(this, arguments));
  }

  _createClass(NetworkHttpComponentQuery, [{
    key: "render",
    value: function render() {
      ...
      return _react.default.createElement(_reactApollo.Query, {
        ...
        var networkHttp = (0, _fp.getOr)([], "source.NetworkHttp.edges", data);
            ...
            updateQuery: function updateQuery(prev, _ref2) {
              ...
              return _objectSpread({}, fetchMoreResult, {
                source: _objectSpread({}, fetchMoreResult.source, {
                  NetworkHttp: _objectSpread({}, fetchMoreResult.source.NetworkHttp, {
                    edges: _toConsumableArray(fetchMoreResult.source.NetworkHttp.edges)
                  })
                })
              });
            }
        ...
        return children({
          id: id,
          inspect: (0, _fp.getOr)(null, 'source.NetworkHttp.inspect', data),
          isInspected: isInspected,
          loading: isLoading,
          loadPage: _this.wrappedLoadMore,
          networkHttp: networkHttp,
          pageInfo: (0, _fp.getOr)({}, 'source.NetworkHttp.pageInfo', data),
          refetch: _this.memoizedRefetchQuery(variables, limit, refetch),
          totalCount: (0, _fp.getOr)(-1, 'source.NetworkHttp.totalCount', data)
        });
      });
    }
  }]);

  return NetworkHttpComponentQuery;
}(_query_template_paginated.QueryTemplatePaginated);

var makeMapStateToProps = function makeMapStateToProps() {
  var getHttpSelector = _store.networkSelectors.httpSelector();
  ...
  return function (state, _ref3) {
    ...
    return _objectSpread({}, getHttpSelector(state, type), {
      isInspected: isInspected
    });
  };
};

var NetworkHttpQuery = (0, _redux.compose)((0, _reactRedux.connect)(makeMapStateToProps), _kibana.withKibana)(NetworkHttpComponentQuery);
