...
exports.mockBrowserFields = exports.mockIndexFields = exports.mocksSource = void 0;
  ...
  result: {
    data: {
      source: {
        ...
        status: {
          indicesExist: true,
          winlogbeatIndices: ['winlogbeat-7.0.0-2019.02.17', 'winlogbeat-7.0.0-2019.02.18', 'winlogbeat-7.0.0-2019.02.19', 'winlogbeat-7.0.0-2019.02.20', 'winlogbeat-7.0.0-2019.02.21', 'winlogbeat-7.0.0-2019.02.21-000001', 'winlogbeat-7.0.0-2019.02.22', 'winlogbeat-8.0.0-2019.02.19-000001'],
          auditbeatIndices: ['auditbeat-7.0.0-2019.02.17', 'auditbeat-7.0.0-2019.02.18', 'auditbeat-7.0.0-2019.02.19', 'auditbeat-7.0.0-2019.02.20', 'auditbeat-7.0.0-2019.02.21', 'auditbeat-7.0.0-2019.02.21-000001', 'auditbeat-7.0.0-2019.02.22', 'auditbeat-8.0.0-2019.02.19-000001'],
          filebeatIndices: ['filebeat-7.0.0-iot-2019.06', 'filebeat-7.0.0-iot-2019.07', 'filebeat-7.0.0-iot-2019.08', 'filebeat-7.0.0-iot-2019.09', 'filebeat-7.0.0-iot-2019.10', 'filebeat-8.0.0-2019.02.19-000001'],
          indexFields: [{
            category: 'base',
            ...
            example: null,
            format: '',
            indexes: _default_index_pattern.defaultIndexPattern,
            name: 'event.end',
            searchable: true,
            type: 'date'
          }]
...
exports.mocksSource = mocksSource;
var mockIndexFields = [{
  aggregatable: true,
  name: '@timestamp',
  searchable: true,
...
exports.mockIndexFields = mockIndexFields;
var mockBrowserFields = {
  agent: {
    fields: {
      'agent.ephemeral_id': {
        aggregatable: true,
...
exports.mockBrowserFields = mockBrowserFields;