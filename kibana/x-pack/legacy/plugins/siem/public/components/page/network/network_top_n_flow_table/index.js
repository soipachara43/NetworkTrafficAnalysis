...
var NetworkTopNFlowTableComponent = function NetworkTopNFlowTableComponent(_ref) {
  ...
  var columns = (0, _react.useMemo)(function () {
    return (0, _columns.getNFlowColumnsCurated)(flowTargeted, type, NetworkTopNFlowTableId);
  }, [flowTargeted, type]);
  var tableType;
  var headerTitle = flowTargeted === _types.FlowTargetSourceDest.source ? i18n.SOURCE_IP : i18n.DESTINATION_IP;

  if (type === _store.networkModel.NetworkType.page) {
    tableType = flowTargeted === _types.FlowTargetSourceDest.source ? _store.networkModel.NetworkTableType.topNFlowSource : _store.networkModel.NetworkTableType.topNFlowDestination;
  } else {
    tableType = flowTargeted === _types.FlowTargetSourceDest.source ? _store.networkModel.IpDetailsTableType.topNFlowSource : _store.networkModel.IpDetailsTableType.topNFlowDestination;
  }
  ...
  var onChange = (0, _react.useCallback)(function (criteria) {
    if (criteria.sort != null) {
      ...
      var _field = (0, _fp.last)(splitField);

      var newSortDirection = _field !== sort.field ? _types.Direction.desc : criteria.sort.direction; // sort by desc on init click
      ...
      if (!(0, _fastDeepEqual.default)(newTopNFlowSort, sort)) {
        updateNetworkTable({
          networkType: type,
          tableType: tableType,
          updates: {
...
var makeMapStateToProps = function makeMapStateToProps() {
  ...
  return function (state, _ref2) {
    ...
    return getTopNFlowSelector(state, type, flowTargeted);
  };
};
...
var NetworkTopNFlowTable = connector(_react.default.memo(NetworkTopNFlowTableComponent));
