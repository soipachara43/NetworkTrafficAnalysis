 ...
 * @param props
 */
function NativeRenderer(_ref) {
  var render = _ref.render,
      nativeProps = _ref.nativeProps,
      tag = _ref.tag,
      rest = _objectWithoutProperties(_ref, ["render", "nativeProps", "tag"]);

  return _react.default.createElement(tag || 'div', _objectSpread({}, rest, {
    ref: function ref(el) {
      return el && render(el, nativeProps);
    }
  }));
}