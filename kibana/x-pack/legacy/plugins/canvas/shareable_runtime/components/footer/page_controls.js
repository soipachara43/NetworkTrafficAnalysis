...
const PageControlsComponent = ({
  ...
  return _react.default.createElement(_eui.EuiFlexGroup, {
    ...
    color: "ghost",
    size: "s"
  }, "Page ", currentPage, totalPages > 1 ? ` of ${totalPages}` : null))), _react.default.createElement(_eui.EuiFlexItem, {
    grow: false
  }, _react.default.createElement(_eui.EuiButtonIcon, {
    color: "ghost",
...
const PageControls = () => {
  ...
  return _react.default.createElement(PageControlsComponent, {
    onToggleScrubber,
    onSetPageNumber,
    page,
    totalPages
