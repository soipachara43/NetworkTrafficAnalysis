...
const SettingsComponent = ({
  ...
  const button = _react.default.createElement(_eui.EuiButtonIcon, {
    color: "ghost",
    iconType: "gear",
    "aria-label": "Settings",
  ...
  const panels = flattenPanelTree({
    ...
    items: [{
      ...
      panel: {
        id: 1,
        title: 'Auto Play',
        content: _react.default.createElement(_autoplay_settings.AutoplaySettings, null)
      }
    }, {
      name: 'Toolbar',
      ...
      panel: {
        id: 2,
        title: 'Toolbar',
        content: _react.default.createElement(_toolbar_settings.ToolbarSettings, {
...
const Settings = () => {
  ...
  return _react.default.createElement(SettingsComponent, {
    refs: refs
  });
};
