...
const ScrubberComponent = ({
  ...
  const slides = pages.map((page, index) => _react.default.createElement(_page_preview.PagePreview, _extends({
    key: page.id,
...
const Scrubber = () => {
  ...
  return _react.default.createElement(ScrubberComponent, {
    pages,
    isScrubberVisible
  });
};
