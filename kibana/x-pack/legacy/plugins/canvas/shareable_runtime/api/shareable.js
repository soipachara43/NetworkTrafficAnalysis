...
const updateArea = async area => {
  ...
  if (url) {
    ...
    if (workpad) {
      ...
      (0, _reactDom.render)([_react.default.createElement("style", {
        key: "style"
      }, `html body .kbnCanvas { height: ${stage.height}px; width: ${stage.width}px; }`), _react.default.createElement(_app.App, _extends({
        key: "app",
        workpad: workpad
      }, {
        stage,
