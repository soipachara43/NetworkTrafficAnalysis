...
}, story())).add('extended', () => _react2.default.createElement(Interactive, null));
...
}, story())).add('extended disabled', () => _react2.default.createElement(_extended_template.ExtendedTemplate, {
  onValueChange: (0, _addonActions.action)('onValueChange'),
  argValue: false,
  typeInstance: {
    name: 'yaxis'
  }
})).add('extended', () => _react2.default.createElement(_extended_template.ExtendedTemplate, {
  onValueChange: (0, _addonActions.action)('onValueChange'),
  argValue: defaultExpression,
  typeInstance: {
    name: 'yaxis'
