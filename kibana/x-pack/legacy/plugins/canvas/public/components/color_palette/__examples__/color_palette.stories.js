...
(0, _react.storiesOf)('components/Color/ColorPalette', module).add('three colors', function () {
  return _react2.default.createElement(_react2.default.Fragment, null, _react2.default.createElement(_color_palette.ColorPalette, {
    key: "1",
