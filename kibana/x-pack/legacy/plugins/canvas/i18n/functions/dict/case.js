...
const help = {
  ...
  args: {
    ...
    if: _i18n.i18n.translate('xpack.canvas.functions.case.args.ifHelpText', {
      defaultMessage: 'This value indicates whether the condition is met, usually using a sub-expression. The {IF_ARG} argument overrides the {WHEN_ARG} argument when both are provided.',
      values: {
        IF_ARG,
        WHEN_ARG
      }
