...
const help = {
  help: _i18n.i18n.translate('xpack.canvas.functions.plyHelpText', {
    defaultMessage: 'Subdivides a {DATATABLE} by the unique values of the specified column, ' + 'and passes the resulting tables into an expression, then merges the outputs of each expression',
    values: {
