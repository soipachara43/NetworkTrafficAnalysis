...
const help = {
  help: _i18n.i18n.translate('xpack.canvas.functions.urlparamHelpText', {
    defaultMessage: 'Retreives a {URL} parameter to use in an expression. ' + 'The {urlparamFn} function always returns a {TYPE_STRING}. ' + 'For example, you can retrieve the value {value} from the parameter {myVar} from the {URL} {example}).',
    values: {
