...
const ComponentStrings = {
  ...
  AssetManager: {
    ...
    getConfirmModalButtonLabel: () => _i18n.i18n.translate('xpack.canvas.assetManager.confirmModalButtonLabel', {
      defaultMessage: 'Remove'
    }),
    getConfirmModalMessageText: () => _i18n.i18n.translate('xpack.canvas.assetManager.confirmModalDetail', {
      defaultMessage: 'Are you sure you want to remove this asset?'
    }),
    getConfirmModalTitle: () => _i18n.i18n.translate('xpack.canvas.assetManager.confirmModalTitle', {
  ...
  ElementTypes: {
    getEditElementTitle: () => _i18n.i18n.translate('xpack.canvas.elementTypes.editElementTitle', {
      defaultMessage: 'Edit element'
    }),
    getDeleteElementTitle: elementName => _i18n.i18n.translate('xpack.canvas.elementTypes.deleteElementTitle', {
      defaultMessage: `Delete element '{elementName}'?`,
      values: {
        elementName
      }
    }),
    getDeleteElementDescription: () => _i18n.i18n.translate('xpack.canvas.elementTypes.deleteElementDescription', {
      defaultMessage: 'Are you sure you want to delete this element?'
    }),
    getCancelButtonLabel: () => _i18n.i18n.translate('xpack.canvas.elementTypes.cancelButtonLabel', {
      defaultMessage: 'Cancel'
    }),
    getDeleteButtonLabel: () => _i18n.i18n.translate('xpack.canvas.elementTypes.deleteButtonLabel', {
      defaultMessage: 'Delete'
    }),
    getAddNewElementTitle: () => _i18n.i18n.translate('xpack.canvas.elementTypes.addNewElementTitle', {
      defaultMessage: 'Add new elements'
    }),
    getAddNewElementDescription: () => _i18n.i18n.translate('xpack.canvas.elementTypes.addNewElementDescription', {
      defaultMessage: 'Group and save workpad elements to create new elements'
    }),
    getFindElementPlaceholder: () => _i18n.i18n.translate('xpack.canvas.elementTypes.findElementPlaceholder', {
      defaultMessage: 'Find element'
    }),
    getElementsTitle: () => _i18n.i18n.translate('xpack.canvas.elementTypes.elementsTitle', {
      defaultMessage: 'Elements',
      description: 'Title for the "Elements" tab when adding a new element'
    }),
    getMyElementsTitle: () => _i18n.i18n.translate('xpack.canvas.elementTypes.myElementsTitle', {
  ...
  ShareWebsiteFlyout: {
    ...
    getUnsupportedRendererWarning: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.unsupportedRendererWarning', {
  ...
  SidebarHeader: {
    getAlignmentMenuItemLabel: () => _i18n.i18n.translate('xpack.canvas.sidebarHeader.alignmentMenuItemLabel', {
    ...
    getBottomAlignMenuItemLabel: () => _i18n.i18n.translate('xpack.canvas.sidebarHeader.bottomAlignMenuItemLabel', {
    ...
    getCenterAlignMenuItemLabel: () => _i18n.i18n.translate('xpack.canvas.sidebarHeader.centerAlignMenuItemLabel', {
      defaultMessage: 'Center',
      description: 'This refers to alignment centered horizontally.'
    }),
    getContextMenuTitle: () => _i18n.i18n.translate('xpack.canvas.sidebarHeader.contextMenuAriaLabel', {
      defaultMessage: 'Element options'
    }),
    getCreateElementModalTitle: () => _i18n.i18n.translate('xpack.canvas.sidebarHeader.createElementModalTitle', {
      defaultMessage: 'Create new element'
    }),
    getDistributionMenuItemLabel: () => _i18n.i18n.translate('xpack.canvas.sidebarHeader.distributionMenutItemLabel', {
      defaultMessage: 'Distribution',
      description: 'This refers to the options to evenly spacing the selected elements horizontall or vertically.'
    }),
    getGroupMenuItemLabel: () => _i18n.i18n.translate('xpack.canvas.sidebarHeader.groupMenuItemLabel', {
      defaultMessage: 'Group',
      description: 'This refers to grouping multiple selected elements.'
    }),
    getHorizontalDistributionMenuItemLabel: () => _i18n.i18n.translate('xpack.canvas.sidebarHeader.horizontalDistributionMenutItemLabel', {
      defaultMessage: 'Horizontal'
    }),
    getLeftAlignMenuItemLabel: () => _i18n.i18n.translate('xpack.canvas.sidebarHeader.leftAlignMenuItemLabel', {
      defaultMessage: 'Left'
    }),
    getMiddleAlignMenuItemLabel: () => _i18n.i18n.translate('xpack.canvas.sidebarHeader.middleAlignMenuItemLabel', {
      defaultMessage: 'Middle',
      description: 'This refers to alignment centered vertically.'
    }),
    getOrderMenuItemLabel: () => _i18n.i18n.translate('xpack.canvas.sidebarHeader.orderMenuItemLabel', {
      defaultMessage: 'Order',
      description: 'Refers to the order of the elements displayed on the page from front to back'
    }),
    getRightAlignMenuItemLabel: () => _i18n.i18n.translate('xpack.canvas.sidebarHeader.rightAlignMenuItemLabel', {
      defaultMessage: 'Right'
    }),
    getSaveElementMenuItemLabel: () => _i18n.i18n.translate('xpack.canvas.sidebarHeader.savedElementMenuItemLabel', {
    ...
    getTopAlignMenuItemLabel: () => _i18n.i18n.translate('xpack.canvas.sidebarHeader.topAlignMenuItemLabel', {
      defaultMessage: 'Top'
    }),
    getUngroupMenuItemLabel: () => _i18n.i18n.translate('xpack.canvas.sidebarHeader.ungroupMenuItemLabel', {
      defaultMessage: 'Ungroup',
      description: 'This refers to ungrouping a grouped element'
    }),
    getVerticalDistributionMenuItemLabel: () => _i18n.i18n.translate('xpack.canvas.sidebarHeader.verticalDistributionMenutItemLabel', {
  ...
  WorkpadHeader: {
    ...
    getAddElementModalCloseButtonLabel: () => _i18n.i18n.translate('xpack.canvas.workpadHeader.addElementModalCloseButtonLabel', {
      defaultMessage: 'Close'
    }),
    getEmbedObjectButtonLabel: () => _i18n.i18n.translate('xpack.canvas.workpadHeader.embedObjectButtonLabel', {
      defaultMessage: 'Embed object'
    }),
  ...
  WorkpadHeaderControlSettings: {
    getTooltip: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderControlSettings.settingsTooltip', {
  ...
  WorkpadHeaderWorkpadExport: {
    getCopyPDFMessage: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.copyPDFMessage', {
    ...
    getCopyReportingConfigMessage: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.copyReportingConfigMessage', {
      defaultMessage: 'Copied reporting configuration to clipboard'
    }),
    getCopyShareConfigMessage: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.copyShareConfigMessage', {
      defaultMessage: 'Copied share markup to clipboard'
    }),
    getExportPDFErrorTitle: workpadName => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.exportPDFErrorMessage', {
    ...
    getExportPDFMessage: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.exportPDFMessage', {
      defaultMessage: 'Exporting {PDF}. You can track the progress in Management.',
      values: {
        PDF: _constants.PDF
      }
    }),
    getExportPDFTitle: workpadName => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.exportPDFTitle', {
    ...
    getPDFPanelCopyAriaLabel: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.pdfPanelCopyAriaLabel', {
    ...
    getPDFPanelCopyButtonLabel: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.pdfPanelCopyButtonLabel', {
    ...
    getPDFPanelCopyDescription: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.pdfPanelCopyDescription', {
    ...
    getPDFPanelGenerateButtonLabel: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.pdfPanelGenerateButtonLabel', {
      defaultMessage: 'Generate {PDF}',
      values: {
        PDF: _constants.PDF
      }
    }),
    getPDFPanelGenerateDescription: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.pdfPanelGenerateDescription', {
      defaultMessage: '{PDF}s can take a minute or two to generate based on the size of your workpad.',
      values: {
        PDF: _constants.PDF
      }
    }),
    getShareableZipErrorTitle: workpadName => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.shareWebsiteErrorTitle', {
    ...
    getShareDownloadJSONTitle: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.shareDownloadJSONTitle', {
      defaultMessage: 'Download as {JSON}',
      values: {
        JSON: _constants.JSON
      }
    }),
    getShareDownloadPDFTitle: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.shareDownloadPDFTitle', {
      defaultMessage: '{PDF} reports',
      values: {
        PDF: _constants.PDF
      }
    }),
    getShareWebsiteTitle: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.shareWebsiteTitle', {
      defaultMessage: 'Share on a website'
    }),
    getShareWorkpadMessage: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.shareWorkpadMessage', {
      defaultMessage: 'Share this workpad'
    }),
    getUnknownExportErrorMessage: type => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadExport.unknownExportErrorMessage', {
  ...
  WorkpadHeaderWorkpadZoom: {
    getZoomControlsAriaLabel: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadZoom.zoomControlsAriaLabel', {
      defaultMessage: 'Zoom controls'
    }),
    getZoomControlsTooltip: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadZoom.zoomControlsTooltip', {
      defaultMessage: 'Zoom controls'
    }),
    getZoomFitToWindowText: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadZoom.zoomFitToWindowText', {
      defaultMessage: 'Fit to window'
    }),
    getZoomInText: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadZoom.zoomInText', {
      defaultMessage: 'Zoom in'
    }),
    getZoomOutText: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadZoom.zoomOutText', {
      defaultMessage: 'Zoom out'
    }),
    getZoomPanelTitle: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadZoom.zoomPanelTitle', {
      defaultMessage: 'Zoom'
    }),
    getZoomPercentage: scale => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadZoom.zoomResetText', {
      defaultMessage: '{scalePercentage}%',
      values: {
        scalePercentage: scale * 100
      }
    }),
    getZoomResetText: () => _i18n.i18n.translate('xpack.canvas.workpadHeaderWorkpadZoom.zoomPrecentageValue', {
      defaultMessage: 'Reset'
    })
  },
  WorkpadLoader: {
