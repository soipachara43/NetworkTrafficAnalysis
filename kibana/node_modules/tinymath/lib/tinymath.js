...
tinymath @ 1.2.0
License: Apache-2.0
Built: 2019-01-16T19:49:06.033Z
*/
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
  typeof define === 'function' && define.amd ? define(['exports'], factory) :
  (global = global || self, factory(global.tinymath = {}));
   ...
   */
  function random(a, b) {
    if (a == null) return Math.random(); // a: max, generate random number between 0 and a
  ...
  function interpret(node, scope, injectedFunctions) {
    const functions$$1 = Object.assign({}, functions, injectedFunctions); // eslint-disable-line
  ...
  function getValue(scope, node) {
    ...
    const val = objectGet_1(scope, node);
