...
exports.BARCHART_2Y0G = [
    { x: 0, y1: 1, y2: 3 },
    { x: 1, y1: 2, y2: 7 },
    { x: 2, y1: 1, y2: 2 },
    { x: 3, y1: 6, y2: 10 },
];
exports.CHART_ORDINAL_2Y0G = [
    { x: 'a', y1: 1, y2: 3 },
    { x: 'b', y1: 2, y2: 7 },
    { x: 'c', y1: 1, y2: 2 },
    { x: 'd', y1: 6, y2: 10 },
];
exports.BARCHART_2Y1G = [
    { x: 0, g: 'a', y1: 1, y2: 4 },
    { x: 0, g: 'b', y1: 3, y2: 6 },
    { x: 1, g: 'a', y1: 2, y2: 1 },
    { x: 1, g: 'b', y1: 2, y2: 5 },
...
exports.TIME_CHART_2Y0G = [
    { x: NOW, y1: 1, y2: 3 },
    { x: NOW + DAY, y1: 2, y2: 7 },
    { x: NOW + DAY * 2, y1: 1, y2: 2 },
    { x: NOW + DAY * 3, y1: 6, y2: 10 },
];
//# sourceMappingURL=test_dataset.js.map