...
var EuiListGroup = function EuiListGroup(_ref) {
  var children = _ref.children,
      ...
      rest = (0, _objectWithoutProperties2.default)(_ref, ["children", "className", "listItems", "style", "flush", "bordered", "gutterSize", "wrapText", "maxWidth", "showToolTips", "ariaLabelledby"]);
  var newStyle;
  var widthClassName;
  ...
  if (listItems) {
    childrenOrListItems = listItems.map(function (item, index) {
      return [_react.default.createElement(_list_group_item.EuiListGroupItem, (0, _extends2.default)({
...
EuiListGroup.propTypes = {
  ...
  listItems: _propTypes.default.arrayOf(_propTypes.default.shape({
    ...
    /**
         ...
         */
    color: _propTypes.default.oneOf(["inherit", "primary", "text", "subdued"]),
