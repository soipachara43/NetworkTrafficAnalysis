...
function (_Component) {
  ...
  function EuiBasicTable() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(EuiBasicTable)).call.apply(_getPrototypeOf2, [this].concat(args)));
