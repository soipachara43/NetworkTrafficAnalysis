...
var EuiAvatar = function EuiAvatar(_ref) {
  var className = _ref.className,
      ...
      rest = (0, _objectWithoutProperties2.default)(_ref, ["className", "color", "imageUrl", "initials", "initialsLength", "name", "size", "type"]);
...
function checkValidColor(color) {
  var validHex = color && (0, _color.isValidHex)(color);
