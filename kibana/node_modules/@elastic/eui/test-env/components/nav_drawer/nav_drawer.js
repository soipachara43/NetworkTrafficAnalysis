...
function (_Component) {
  ...
  function EuiNavDrawer(props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(EuiNavDrawer).call(this, props));
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleDrawerMenuClick", function (e) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "modifyChildren", function (children) {
      ...
      return _react.default.Children.map(filteredChildren, function (child) {
        ...
        } else if (child.type === _nav_drawer_group.EuiNavDrawerGroup) {
  ...
  (0, _createClass2.default)(EuiNavDrawer, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          rest = (0, _objectWithoutProperties2.default)(_this$props, ["children", "className", "showExpandButton", "showToolTips", "isCollapsed", "isLocked", "onIsLockedUpdate"]);
