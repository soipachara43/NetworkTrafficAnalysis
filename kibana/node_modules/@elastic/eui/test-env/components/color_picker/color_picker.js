...
function isKeyboardEvent(event) {
  return (0, _typeof2.default)(event) === 'object' && 'keyCode' in event;
}
...
var EuiColorPicker = function EuiColorPicker(_ref) {
  var button = _ref.button,
      ...
      append = _ref.append;
  var getHsvFromColor = (0, _react.useCallback)(function () {
    return color && chromaValid(color) ? (0, _chromaJs.default)(color).hsv() : [0, 0, 0];
  }, [color]);
  ...
  var _useState3 = (0, _react.useState)(getHsvFromColor()),
  ...
  (0, _react.useEffect)(function () {
    if (lastHex !== color) {
      ...
      var newColorAsHsv = getHsvFromColor();
  ...
  var handleColorInput = function handleColorInput(e) {
    ...
    if (chromaValid(e.target.value)) {
      updateColorAsHsv((0, _chromaJs.default)(e.target.value).hsv());
    }
  };

  var handleColorSelection = function handleColorSelection(color) {
    var _colorAsHsv = (0, _slicedToArray2.default)(colorAsHsv, 1),
        h = _colorAsHsv[0];
    ...
    var newHsv = [h, s, v];
    handleOnChange(_chromaJs.default.hsv.apply(_chromaJs.default, newHsv).hex());
    updateColorAsHsv(newHsv);
  };

  var handleHueSelection = function handleHueSelection(hue) {
    var _colorAsHsv2 = (0, _slicedToArray2.default)(colorAsHsv, 3),
        s = _colorAsHsv2[1],
        v = _colorAsHsv2[2];
  ...
  var handleSwatchSelection = function handleSwatchSelection(color) {
    ...
    updateColorAsHsv((0, _chromaJs.default)(color).hsv());
    handleFinalSelection();
  };
  ...
  var composite = _react.default.createElement(_react.default.Fragment, null, mode !== 'swatch' && _react.default.createElement("div", {
    ...
    id: id,
    color: (0, _typeof2.default)(colorAsHsv) === 'object' ? colorAsHsv : undefined,
    hex: color || undefined,
    onChange: handleColorSelection,
    ref: satruationRef
  }), _react.default.createElement(_hue.EuiHue, {
    id: id,
    hue: (0, _typeof2.default)(colorAsHsv) === 'object' ? colorAsHsv[0] : undefined,
    hex: color || undefined,
  ...
  if (button) {
    ...
    var showColor = color && chromaValid(color);
