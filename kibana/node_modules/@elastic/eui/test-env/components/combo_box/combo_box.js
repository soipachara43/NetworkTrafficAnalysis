...
function (_Component) {
  ...
  function EuiComboBox() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "addCustomOption", function (isContainerBlur) {
  ...
  (0, _createClass2.default)(EuiComboBox, [{
    ...
    value: function render() {
      var _this$props8 = this.props,
          ...
          rest = (0, _objectWithoutProperties2.default)(_this$props8, ["data-test-subj", "async", "className", "compressed", "fullWidth", "id", "inputRef", "isClearable", "isDisabled", "isInvalid", "isLoading", "noSuggestions", "onBlur", "onChange", "onCreateOption", "onSearchChange", "options", "placeholder", "renderOption", "rowHeight", "selectedOptions", "singleSelection"]);
      var _this$state3 = this.state,
          ...
          width = _this$state3.width; // Visually indicate the combobox is in an invalid state if it has lost focus but there is text entered in the input.
