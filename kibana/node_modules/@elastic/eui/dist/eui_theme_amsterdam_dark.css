...
.euiControlBar__tab {
  ...
  .euiControlBar__tab.euiControlBar__tab--active {
    background-color: #1a1b20;
    -webkit-box-shadow: inset 0 4px 0 #6db2ff;
            box-shadow: inset 0 4px 0 #6db2ff;
    color: #6db2ff; }
...
.euiStepHorizontal-isSelected .euiStepHorizontal__number:not([class*='danger']):not([class*='warning']) {
  -webkit-box-shadow: 0 2px 2px -1px rgba(57, 141, 233, 0.3);
          box-shadow: 0 2px 2px -1px rgba(57, 141, 233, 0.3); }
