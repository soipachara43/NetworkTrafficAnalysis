...
var EuiListGroupItem = function EuiListGroupItem(_ref) {
  var label = _ref.label,
      ...
      rest = _objectWithoutProperties(_ref, ["label", "isActive", "isDisabled", "href", "className", "iconType", "icon", "extraAction", "onClick", "size", "color", "showToolTip", "wrapText", "buttonRef"]);
