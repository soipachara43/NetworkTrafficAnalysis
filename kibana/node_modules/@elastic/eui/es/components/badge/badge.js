...
export var EuiBadge = function EuiBadge(_ref) {
  ...
  if (iconType) {
    if (iconOnClick) {
      ...
      optionalIcon = React.createElement("button", {
        className: "euiBadge__iconButton",
        "aria-label": iconOnClickAriaLabel,
        disabled: isDisabled,
        title: iconOnClickAriaLabel,
        onClick: iconOnClick
      }, React.createElement(EuiIcon, _extends({
        type: iconType,
        size: "s"
      }, closeButtonProps, {
  ...
  if (onClick && iconOnClick) {
    ...
    }, React.createElement(EuiInnerText, null, function (ref, innerText) {
    ...
    return React.createElement(EuiInnerText, null, function (ref, innerText) {
      return React.createElement("button", _extends({
        disabled: isDisabled,
        "aria-label": onClickAriaLabel,
        className: classes,
...
function checkValidColor(color) {
  if (color != null && !isValidHex(color) && !COLORS.includes(color) && color !== 'hollow') {
