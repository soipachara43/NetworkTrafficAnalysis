...
.euiButtonEmpty--disabled {
  color: #b1b2b2; }
  .euiButtonEmpty--disabled:focus {
    background-color: rgba(117, 118, 120, 0.1); }
...
.euiControlBar__tab {
  ...
  .euiControlBar__tab.euiControlBar__tab--active {
    background-color: #1a1b20;
    -webkit-box-shadow: inset 0 4px 0 #45b9f6;
            box-shadow: inset 0 4px 0 #45b9f6;
    color: #45b9f6; }
...
.euiListGroup--gutterS {
  padding: 8px; }
  .euiListGroup--gutterS .euiListGroupItem:not(:first-of-type) {
    margin-top: 8px; }

.euiListGroup--gutterM {
  padding: 16px; }
  .euiListGroup--gutterM .euiListGroupItem:not(:first-of-type) {
    margin-top: 16px; }
...
.euiListGroupItem__button {
  ...
  .euiListGroupItem__button {
    max-width: calc(100% - 32px); }
  .euiListGroupItem--primary .euiListGroupItem__text, .euiListGroupItem--primary
  .euiListGroupItem__button {
    color: #1BA9F5; }
  .euiListGroupItem--text .euiListGroupItem__text, .euiListGroupItem--text
  .euiListGroupItem__button {
    color: #DFE5EF; }
  .euiListGroupItem--subdued .euiListGroupItem__text, .euiListGroupItem--subdued
  .euiListGroupItem__button {
    color: #98A2B3; }
